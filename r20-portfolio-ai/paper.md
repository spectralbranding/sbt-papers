...
seo_description: Experiment with 7,975 API calls testing whether LVMH/Unilever/P&G/Toyota/L'Oreal/Geely/Yandex portfolio context changes how 13 LLMs from 7 training traditions perceive brands.
-->
...
Total: approximately 7,930 observation cells (7,975 successfully parsed). All ratings used a 1--5 scale following the PRISM-B specification (Zharnikov 2026aa).
