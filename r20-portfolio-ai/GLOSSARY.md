...
_Terms used by **2026ab** (R20: Portfolio AI). Defined terms this paper introduces, refines, or imports from the corpus ontology._

*Terms introduced by this paper*

- **Awareness Gate Paradox** (write: `awareness gate paradox`)
  - The tension that, because LLMs encode portfolio relationships permanently (a saturated awareness gate), standard portfolio theory predicts maximal interference whereas a compressed-encoding account predicts complete immunity.
  - first use: The Awareness Gate Paradox
