...
Owned by prism_core (the PRISM instrument-family base library) since
2026-07-02; previously at code/. The move fixes
...
Logs land at the caller-supplied logs_dir; every PRISM campaign passes its
own logs/ explicitly (prism_core.provider requires the argument).
"""
...
# Default logs directory (fallback only — campaign callers pass logs_dir).
...
def _env_hash() -> str:
    ...
    """
    # [internal path removed] -> parents[2] = repo root
