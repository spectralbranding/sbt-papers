...
The ratio $H_{\text{WM}} / H_{48} = 23.2 / 159.4 = 14.6\%$ means that a human designer can hold approximately one-seventh of a full organizational specification in working memory at any given time. Under Cowan's [-@cowan-2001-magical-number-4] revised estimate of 4 chunks, the ratio falls to 8.3%. This is not a limitation of particular individuals but a fundamental constraint of human cognition applied to high-dimensional specification.
