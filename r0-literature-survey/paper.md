...
No existing tradition satisfies all six criteria. Before reading that as a finding about the traditions, it is worth being explicit about where the criteria came from: they are this survey's own, stipulated from the structural absences catalogued above, and they name the properties a candidate framework is being built to supply. A tradition that was never trying to supply all six is not thereby deficient, and the joint shortfall is a property of the criterion set as much as of the literature. What the classification matrix contributes is to state that set explicitly and place each tradition against it. Each tradition excels on one or two criteria while leaving others unaddressed:
