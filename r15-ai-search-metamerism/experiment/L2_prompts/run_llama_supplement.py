#!/usr/bin/env python3
"""Llama 3.3 70B supplement for Compounding x Format v2.

Replaces Claude (which refused constraint/step_3 due to ethical override)
with Llama 3.3 70B via Groq (free endpoint). Runs all 3 conditions.
"""
...
OUTFILE = Path(__file__).parent.parent / "L3_sessions" / "exp_compounding_format_v2_llama_supplement.jsonl"
...
def main():
    ...
    print(f"Llama 3.3 70B supplement: 3 conditions x 5 brands x 2 reps")
        ...
        for brand_name in BRANDS:
            for rep in range(1, 3):
                ...
                for step in range(1, 4):
                    ...
                    record = {
                        "experiment": "exp_compounding_format_v2_llama_supplement",
