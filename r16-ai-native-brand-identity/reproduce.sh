...
huggingface-cli download spectralbranding/exp-bf-format --repo-type dataset --local-dir experiment/_hf/exp-bf-format  # DOI 10.57967/hf/8440
huggingface-cli download spectralbranding/r16-behavioral-metamerism-pilot --repo-type dataset --local-dir experiment/_hf/r16-behavioral-metamerism-pilot  # DOI 10.57967/hf/8442
