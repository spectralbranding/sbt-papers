...
The disagreement across frameworks is striking. J. Aaker's [-@aaker-1997-dimensions-brand-personality] brand personality scale, developed through factor analysis of 114 personality traits rated across 37 brands, yielded five factors: sincerity, excitement, competence, sophistication, and ruggedness. Keller's [-@keller-1993-conceptualizing-measuring-managing] Customer-Based Brand Equity framework organizes brand knowledge around four hierarchical levels: identity, meaning, response, and relationships. Kapferer's [-@kapferer-2008-new-strategic-brand, 4th ed.] brand identity prism posits six facets: physique, personality, culture, relationship, reflection, and self-image. De Chernatony and McDonald [-@chernatony-2003-creating-powerful-brands] catalog eleven "roles" a brand can play. Meanwhile, the multidimensional scaling tradition, dating from Torgerson [-@torgerson-1952-multidimensional-scaling-i] through Green and Rao [-@green-1972-applied-multidimensional-scaling] and Bijmolt and Wedel [-@bijmolt-1999-comparison-multidimensional-scaling], consistently finds that two to three dimensions suffice to explain most variance in perceptual similarity data.

These are not minor discrepancies. A five-dimensional space has fundamentally different geometric properties than a two-dimensional space or an eleven-dimensional space. The number of possible observer weight profiles, the volume of cohort boundaries, the capacity for brand differentiation, and the information loss under projection all depend critically on dimensionality — as the results in Zharnikov [-@zharnikov-2026-spectral-metamerism-brand-perception-projection] and Zharnikov [-@zharnikov-2026-cohort-boundaries-high-dimensional-perception] make formally explicit. Choosing the wrong dimensionality is not a matter of imprecision; it is a structural error that propagates through every downstream analysis.

Two approaches to justifying dimensionality are available. The first is **empirical discovery**: collect perception data across many potential attributes, then use factor analysis or principal component analysis to determine how many latent factors the data support. This is the approach J. Aaker [-@aaker-1997-dimensions-brand-personality] took for brand personality. Its strength is empirical grounding; its weakness is that the discovered factors depend on the input variables — if no items measuring temporal perception are included in the survey, no temporal factor can emerge. The method discovers structure within the measured space, not the completeness of the measurement itself.

The second approach is **theoretical derivation**: argue from established theory that brand perception must involve exactly $n$ channels of meaning transmission, then verify independence and completeness. This is the approach SBT takes, and this paper formalizes. The strength of theoretical derivation is that it can identify dimensions that surveys miss because no one thought to measure them. Its weakness is that the argument depends on the completeness of the theoretical inventory — the claim that all relevant meaning channels have been enumerated. Sweeney and Soutar [-@sweeney-2001-consumer-perceived-value] provide a related example from the consumer value literature: their PERVAL scale, developed through systematic conceptual analysis followed by scale purification, identified four consumer value dimensions (quality, emotional, price, social) that differ from Aaker's personality factors precisely because the two teams started from different theoretical entry points — one from value theory, one from personality psychology. The dimensionality of the output reflects the dimensionality of the input theoretical lens, not the dimensionality of the underlying construct space. This reinforces SBT's argument that theoretical derivation is necessary alongside, not merely supplementary to, empirical discovery.

This paper provides the formal argument for SBT's eight dimensions. It first enumerates the meaning channels from established academic traditions, then establishes independence via counter-example brands and argues non-redundancy. It next demonstrates completeness by showing that candidate additional dimensions reduce to existing ones, compares SBT's taxonomy with alternative frameworks, and resolves the apparent contradiction with MDS findings. It then discusses limitations and provides an empirical robustness test using R15 cross-cultural LLM data, before concluding.

The contribution is a novel theoretical derivation that integrates psychometric and cross-disciplinary criteria to establish an eight-dimensional brand perception taxonomy — to our knowledge, the first completeness-and-independence argument in the brand theory literature to derive the dimensional count from a cross-disciplinary enumeration of meaning-transmission channels and to verify completeness through a constructive reduction test of candidate additional dimensions, drawing on the spectral framework articulated in [@zharnikov-2026-spectral-brand-theory-computational-framework]. MacInnis [-@macinnis-2011-framework-conceptual-contributions] identifies "explicating" contributions — those that clarify the nature of a construct or establish its boundaries — as among the most durable conceptual advances in marketing; this paper aims for that category. Three numbered contributions follow.

1. **Meaning-channel versus content-domain distinction** — a principled stopping rule derived from cross-disciplinary academic traditions rather than factor analysis, preventing indefinite dimensional inflation as new content domains arise.

2. **Constructive independence-and-non-redundancy proof** via brand-pair witnesses and a reduction test for five candidate ninth dimensions, establishing eight as the minimal complete set rather than an arbitrary count.

3. **Empirical robustness test using AI-observer data** subjecting the framework to drop-one, drop-pair, and augmentation perturbations, showing the cross-model ranking pattern is overdetermined — no single dimension carries it — while reporting explicitly which of the three perturbations answers the question it was posed and which do not.

Whether the dimensions are "correct" in an empirical sense remains a question for factor-analytic studies that this paper's argument motivates but does not replace.
...
### Narrative: The Story-Structure Channel

Narratology, rooted in Propp's [-@propp-1928-1968-morphology-folktale] morphology of folk tales, Campbell's [-@campbell-1949-hero-with-thousand] monomyth, and Bruner's [-@bruner-1991-narrative-construction-reality] argument that narrative is a fundamental mode of cognition, studies how sequential, causally connected events are structured to produce meaning. The core construct is the narrative arc: a protagonist encounters obstacles, undergoes transformation, and arrives at a resolution. Bruner [-@bruner-1991-narrative-construction-reality] argued that narrative is not merely a literary form but a primary mode by which humans organize experience and construct reality.
...
### Experiential: The Lived-Encounter Channel

The experience economy literature, formalized by Pine and Gilmore [-@pine-1998-welcome-experience-economy] and extended to marketing by Schmitt [-@schmitt-1999-experiential-marketing-how], studies how direct sensory and cognitive encounters with products and services generate meaning. Phenomenology, from Husserl through Merleau-Ponty, provides the philosophical foundation: meaning is constituted through lived experience, not merely through abstract representation.
...
### Cultural: The Taste-Code Channel

Cultural sociology, particularly Bourdieu's [-@bourdieu-1984-distinction-social-critique] theory of cultural capital and distinction, and cultural consumption theory as applied to marketing by McCracken [-@mccracken-1986-culture-consumption-theoretical], studies how taste systems, aesthetic traditions, and cultural codes generate meaning. The core construct is cultural capital: the knowledge, dispositions, and competencies that enable participation in particular cultural practices.
...
### Temporal: The Heritage-and-Horizon Channel

Temporal psychology, formalized by Zimbardo and Boyd [-@zimbardo-1999-putting-time-perspective] in their time perspective theory and extended to organizational contexts by Shipp, Edwards, and Lambert [-@shipp-2009-conceptualization-measurement-temporal], studies how orientation toward past, present, and future generates meaning. The core construct is temporal focus: the degree to which an entity's identity is anchored in heritage, present experience, or future aspiration.

Brands emit temporal signals. Hermès communicates deep heritage: 187 years of craftsmanship, generational continuity, resistance to trend. Tesla communicates future orientation: the brand's meaning is inseparable from its promise of what transportation will become. Erewhon communicates hyper-present temporality: the brand is about the current moment's wellness zeitgeist, with minimal heritage anchoring and uncertain future trajectory. These temporal signals are processed by observers through psychological mechanisms of nostalgia [@wildschut-2006-nostalgia-content-triggers], future orientation, and temporal discounting.
...
The exhaustiveness claim is, of course, the most vulnerable part of the argument. It is defended not by logical deduction but by scholarly inventory: we have surveyed the literatures on meaning, communication, and perception across the humanities, social sciences, and cognitive science, and we find no established tradition studying a meaning channel not already covered by one of the eight. The analysis below subjects this claim to a stress test by examining candidate ninth dimensions.

### From Academic Traditions to Perception Channels
...
## Independence Proof via Counter-Example Brands
...
### Semiotic Independence: Apple vs. Samsung
...
### Narrative Independence: Patagonia vs. The North Face
...
### Ideological Independence: Chick-fil-A vs. Popeyes
...
### Experiential Independence: Ritz-Carlton vs. Four Seasons
...
### Social Independence: Supreme vs. Carhartt
...
### Economic Independence: Costco vs. Sam's Club
...
### Temporal Independence: Hermès vs. Gucci
...
### Dimensional Non-Redundancy

The independence examples presented earlier establish that each dimension varies independently of the others. Non-redundancy is the complementary claim: each dimension is *necessary* — removing it reduces the framework's discriminative power.
...
*Proof sketch.* For each dimension $d_i$, the counter-example pair from the independence examples serves as $(A_i, B_i)$. By construction, these pairs differ primarily on $d_i$ and are approximately matched on all other dimensions. In the full 8-dimensional space, their Euclidean distance is dominated by the $d_i$ component:

$$\|s_{A_i} - s_{B_i}\|^2 = \sum_{k=1}^{8} (s_{A_i}(d_k) - s_{B_i}(d_k))^2 \approx (s_{A_i}(d_i) - s_{B_i}(d_i))^2$$

Removing dimension $d_i$ eliminates the dominant term, collapsing the distance to approximately zero. The brands become indistinguishable in the reduced space. This proof sketch is conditional on the empirical claim that the witness pairs from the independence examples are approximately matched on non-focal dimensions — a claim this paper does not empirically verify and which constitutes the primary target of future factor-analytic work.
...
*Falsification:* Proposition 1 would be falsified if a large-scale observer-rating study found that, for some dimension $d_i$, no brand pair becomes indistinguishable upon its removal — i.e., if the claimed witness pairs from the independence examples are rated by observers as substantially different on multiple non-focal dimensions, such that removing $d_i$ leaves substantial residual distance. This would indicate that the dimension is not doing discriminative work independently of the others, or that the witness pairs were poorly chosen.
...
## Completeness: The Candidate Ninth Dimension Test
...
### Mapping Frameworks onto SBT Dimensions
...
**J. Aaker [-@aaker-1997-dimensions-brand-personality] Brand Personality.** J. Aaker's five factors were derived from factor analysis of 114 personality-trait ratings applied to 37 brands [@aaker-1997-dimensions-brand-personality]. It is important to distinguish this work from D. Aaker's [-@aaker-1996-building-strong-brands] brand equity framework, which organizes brand knowledge around functional, emotional, and self-expressive benefits rather than personality dimensions. The mapping to SBT dimensions reveals that Brand Personality captures a narrow slice of the full perception space:

| J. Aaker [-@aaker-1997-dimensions-brand-personality] Factor | Primary SBT Dimension(s) | Rationale |
|---|---|---|
...
**Keller [-@keller-1993-conceptualizing-measuring-managing] Customer-Based Brand Equity.** Keller's four-level pyramid is hierarchical rather than dimensional — each level builds on the previous one. The mapping is less direct:
...
**Kapferer [-@kapferer-2008-new-strategic-brand, 4th ed.] Brand Identity Prism.** Kapferer's six facets map onto SBT dimensions with moderate coverage:
...
**De Chernatony and McDonald [-@chernatony-2003-creating-powerful-brands] Brand Roles.** De Chernatony catalogs eleven "roles" a brand plays (logo, instrument, shorthand, risk reducer, identity system, image, value system, personality, relationship, added value, evolving entity). Many of these roles map to the same SBT dimensions:
...
The shared count of eight is not offered here as evidence, and it is worth saying why rather than leaving it as an implication. The mapping just given is many-to-one in both directions: excellence and play both land on Experiential, esteem and status both on Social, aesthetics divides across Semiotic and Cultural, and spirituality across Ideological and Narrative. Two of SBT's channels — Economic and Temporal — receive one value type or none. Frameworks whose elements correspond many-to-one have no reason to share a cardinality, and their doing so is a coincidence of two independent enumeration decisions rather than a convergence on a structure. Nothing about the arbitrariness of eight is settled by it. What the comparison does establish is the complementarity: Holbrook's typology explains what observers are looking for; SBT's framework explains which channels deliver what they find.

### Sheth, Newman, and Gross [-@sheth-1991-why-we-buy] Theory of Consumption Values

Sheth, Newman, and Gross [-@sheth-1991-why-we-buy] proposed a five-value theory of consumption choice: functional value (utilitarian performance), social value (association with demographic, socioeconomic, or cultural-ethnic groups), emotional value (capacity to arouse feelings or affective states), epistemic value (ability to arouse curiosity, provide novelty, or satisfy a desire for knowledge), and conditional value (utility from a specific situation or set of circumstances). This framework is particularly relevant because it was derived from theory rather than from factor analysis of personality traits, making it structurally closer to SBT's derivation methodology than J. Aaker's [-@aaker-1997-dimensions-brand-personality] empirical approach.
...
## Why Two to Three Dimensions Appear Sufficient

### The MDS Dimensionality Puzzle

The multidimensional scaling tradition in marketing, from Torgerson [-@torgerson-1952-multidimensional-scaling-i] through Green and Rao [-@green-1972-applied-multidimensional-scaling] to Bijmolt and Wedel [-@bijmolt-1999-comparison-multidimensional-scaling], has consistently found that two to three dimensions explain most of the variance in perceptual similarity data. If brand perception genuinely involves eight dimensions, why do data-driven methods find so few?
...
Zharnikov [-@zharnikov-2026-cohort-boundaries-high-dimensional-perception] proved that on the probability simplex $\Delta^{n-1}$, the concentration of measure phenomenon causes distances between random points to converge as $n$ increases. At $n = 8$, the Euclidean distance contrast ratio $\max_d / \min_d$ is approximately 7.46, against a ratio of order $10^4$ at $n = 2$. The low-dimensional figure is quoted as an order of magnitude rather than a point estimate because the ratio there is dominated by the closest pair and has no stable mean. More directly, at least 52.2% of the volume of $\Delta^7$ lies within a tenth of a cell's volume radius of the boundary of its own cohort region — a majority of the space is "near a boundary" in the geometric sense.
...
### Variance Dominance versus Information Content

The critical distinction is between variance explained and information retained. Zharnikov [-@zharnikov-2026-spectral-metamerism-brand-perception-projection] proved that projecting from $\mathbb{R}^8$ to $\mathbb{R}^1$ retains at most 11.6% of the available information (measured in bits). A 2-3 dimensional projection retains more, but still sacrifices substantial discriminative capacity.
...
**The completeness argument is theoretical, not empirical.** The claim that eight meaning channels exhaust the relevant channels for brand perception rests on a scholarly inventory of academic traditions, not on factor analysis of perception data. It is possible that empirical investigation will reveal that some SBT dimensions merge under factor analysis — that semiotic and cultural perception, for example, load on a common factor in survey data — or that additional dimensions emerge from items not anticipated by the current taxonomy. An empirical robustness test below partially addresses this limitation using AI observer data: the cross-model ranking survives aggressive perturbation, holding far closer to baseline than a random re-ranking under every single-dimension and pair removal. It does not establish that all eight dimensions carry distinct information — the variance-share decomposition reported there cannot separate that hypothesis from an exchangeable null, and is stated as inconclusive. A definitive test requires human-subject factor analysis, which remains to be conducted.

**The independence examples are illustrative, not measured.** The counter-example brand pairs presented earlier are selected based on the author's informed judgment about brand positioning, not on observer-rated spectral profiles. It is possible that observers rate these pairs as more similar or more different on non-focal dimensions than the argument assumes. Formal independence requires a large-scale study in which observers rate multiple brands across all eight dimensions, followed by analysis of inter-dimensional correlations. Low correlations would confirm independence; high correlations would suggest that some dimensions should be merged.

**The meaning-channel enumeration assumes Western academic traditions.** The eight traditions cited — semiotics, narratology, ideology critique, phenomenology, social identity theory, signaling theory, cultural sociology, temporal psychology — are products of European and North American intellectual history. Non-Western philosophical traditions may carve the meaning space differently. Chinese aesthetics (the integration of form, meaning, and morality in the concept of yi) might argue for a unified aesthetic-ideological channel rather than separate semiotic and ideological channels. Islamic jurisprudence on commerce (muamalat) integrates economic and ethical reasoning in ways that the Western separation of signaling theory and ideology critique does not. Beyond these structural concerns, empirical research on cross-cultural brand perception demonstrates that the structure of brand meaning dimensions is not fully universal: Aaker, Benet-Martínez, and Garolera [-@aaker-2001-consumption-symbols-as] found that brand personality dimensions in Japan and Spain include culture-specific factors (Peacefulness for Japan; Passion for Spain) absent from the U.S. five-factor solution, illustrating the empirical form that cross-cultural variation in meaning-channel structure could take. Similarly, research on cross-cultural cognition demonstrates that Western and East Asian observers differ systematically in holistic versus analytic processing styles [@nisbett-2001-culture-systems-thought], which may affect how different meaning channels are weighted and integrated in brand perception. A culturally universal version of the completeness argument would need to demonstrate that these alternative traditions and processing styles, while offering different internal structures, ultimately address the same set of meaning channels.

**The temporal dimension is the least established in prior brand theory.** While semiotics, narrative, social identity, and cultural sociology have long histories of application to brand and consumption contexts, the temporal dimension — brand perception as a function of the brand's relationship to time — has received less systematic attention. Zimbardo and Boyd's [-@zimbardo-1999-putting-time-perspective] time perspective theory was developed for individual psychology, not for brand perception. The application to brands (heritage, nostalgia, future orientation) is theoretically motivated but empirically underdeveloped relative to the other seven dimensions. A rapidly growing empirical literature on vintage and pre-owned consumption is, however, beginning to close this gap, establishing that observers reliably perceive and assign value to a product's relationship to the past. Vintage has been operationalized as a measurable composite of moderate age, iconicity, and scarcity [@hoff-2026-defining-understanding-vintage]; perceived "consumer pastness" has been shown to raise perceptions of scarcity and purchase intention beyond those for new or second-hand equivalents [@schibik-2022-what-makes-product]; vintage consumption has been demonstrated to forge psychological connections among past, present, and future and to buffer threats to meaning [@sarialabi-2017-stitching-time-vintage]; the purchase of vintage goods is empirically distinguished from ordinary second-hand purchase by nostalgia proneness and the search for uniqueness rather than by frugality [@cervellon-2012-something-old-something]; and pre-owned luxury possessions acquire authenticity and symbolic value precisely from their accumulated histories [@turunen-2015-preloved-luxury-identifying]. This emerging evidence establishes the temporal channel as a genuine, measurable axis of consumer perception rather than a purely theoretical postulate. What it does not yet supply is a brand-level, SBT-specific validation: these findings concern the perception of an object's relationship to the past within particular consumption domains, not a factor-analytic demonstration that temporal perception operates as one of eight orthogonal channels across brands in general. In this respect the temporal dimension is directly analogous to the Honesty-Humility factor in the HEXACO personality model [@ashton-2007-empirical-theoretical-practical]: a theoretically motivated dimension with converging domain evidence that nonetheless preceded large-scale factorial confirmation of its place in the overall structure, having been justified on cross-cultural theoretical grounds beforehand. It remains possible that future work will find temporal perception to be most pronounced for specific brands (those with strong heritage or strong future orientation) rather than operating uniformly as a universal channel that all brands emit on and all observers process through.

**Individual SBT dimensions may themselves be internally multi-dimensional.** Brakus et al. [-@brakus-2009-brand-experience-what] demonstrated that brand experience — the construct SBT captures in its experiential dimension — can be decomposed into four internally distinct sub-dimensions (sensory, affective, intellectual, behavioral). If other SBT dimensions are similarly decomposable, the total number of perceptual factors could exceed eight. SBT's response is that its dimensions are **meaning channels** rather than unitary perceptual factors: each channel describes a mode of meaning transmission between brand and observer, not a unitary psychological construct that must be internally homogeneous. Sub-dimensions of experience describe different modalities within the same channel, not different channels. However, this distinction — between channel-level and factor-level analysis — requires empirical validation. If a large-scale survey produces a solution with more than eight stable factors (for example, if sensory and affective experiential items load on separate factors), the channel-versus-factor distinction must be defended on grounds beyond its theoretical elegance.

**The redundancy test is constructive, not exhaustive.** Proposition 1 shows that for each dimension, a brand pair exists that becomes indistinguishable upon removal. This is a constructive proof — it exhibits witnesses — but does not quantify the frequency or severity of information loss across the full space of possible brand pairs. A quantitative version would require computing the expected information loss (in the sense of Zharnikov, [-@zharnikov-2026-spectral-metamerism-brand-perception-projection]) from removing each dimension across a representative sample of real brand profiles.
...
## Empirical Robustness Test

The preceding sections establish the eight-dimension taxonomy through theoretical argument: completeness from meaning-channel enumeration, independence via counter-example brand pairs, non-redundancy through constructive proof, and resolution of the MDS dimensionality paradox. This section complements the theoretical argument with an empirical robustness test, using data from the R15 cross-cultural LLM experiment [@zharnikov-2026-dimensional-collapse-ai-mediated-search].
...
*Data.* The analysis uses R15 Run 5 weight profiles: 22 large language models from 7 training traditions, each providing 8-dimensional weight allocations (summing to 100 points) for 8 cross-cultural brand pairs, with 3 repetitions per pair per model. Total observations: 11,298 API calls. Model-level profiles are computed as the mean weight vector across all brand pairs and repetitions. The Dimensional Collapse Index (DCI) is computed as $(w_{\text{Economic}} + w_{\text{Semiotic}}) / w_{\text{total}}$, capturing the concentration of weight toward the two dimensions that R15 identified as systematically over-weighted. Baseline mean 8D DCI across 22 models: .356 (SD = .029, range [.290, .402]), exceeding the uniform baseline of .250 by .106 (confirming the dimensional collapse documented in Zharnikov, [-@zharnikov-2026-dimensional-collapse-ai-mediated-search]).
...
*Notes*: Sorted by cosine similarity (ascending = most disruptive). $\text{DCI} = (w_{\text{Economic}} + w_{\text{Semiotic}}) / \text{total}$. Spearman rho and p computed across 22 model-level mean DCI values. Cosine similarity computed between the 22-element DCI vectors of baseline and reduced variants. Mean rank displacement is the absolute number of rank positions shifted, averaged across all 22 models.

Before reading Table 2, two properties of these statistics need stating, because they set what the numbers can and cannot show.

The cosine cannot miss. The DCI vectors compared are 22 positive numbers with mean .356 and SD .029, and for positive vectors of low relative dispersion the cosine is pinned near 1 whatever the relationship between them. Concretely: two **independent** 22-vectors drawn with DCI's own mean and SD have expected cosine $m^2/(m^2+s^2) = .993$, and exceed .994 in 45% of 200,000 simulated draws. A drop-one cosine of .994 is therefore the value unrelated vectors give, not evidence of preserved structure, and the cosine column is reported descriptively rather than as a test. The same reasoning applies to the drop-pair floor of .993.

The mean absolute rank displacement does discriminate, and it is the column to read. Under a uniformly random re-ranking of 22 models the expected displacement is $(n^2-1)/(3n) = 7.32$, with a 95% interval of $[5.27, 9.27]$ across 100,000 draws. Every observed drop-one displacement falls far below that interval: the most disruptive single removal, Economic at 3.55, has $p < .001$ against the random-re-ranking null, and even the most disruptive computable pair removal (5.00, Table 3) has $p = .014$. The reference distribution depends only on the number of models, so no fitting is involved.

A third property is structural rather than statistical. DCI is $(w_{\text{Economic}} + w_{\text{Semiotic}})/\text{total}$, so six of the eight dimensions appear in the index only through its denominator. Removing one of those six can change DCI only by renormalization, which is why their displacements cluster near 1 and their cosines near .9997; the asymmetry between the two numerator dimensions and the other six is built into the metric before any model is queried.

Three findings address RQ1. First, no single dimension is indispensable: every drop-one removal leaves the ranking far closer to baseline than a random re-ranking would ($p < .001$ in all eight cases), and all Spearman rhos are significant at $p < .001$. Second, the DCI-component dimensions dominate disruption: removing Economic (rho = .720, displacement = 3.55 positions) or Semiotic (rho = .737, displacement = 3.36) causes substantially more disruption than removing any non-DCI dimension (all rho > .94, all displacements < 1.5). Because DCI is defined as $(w_{\text{Economic}} + w_{\text{Semiotic}}) / \text{total}$, removing any non-numerator dimension mechanically increases DCI while removing a numerator dimension decreases it; this structural asymmetry must be borne in mind when interpreting Table 2 results. Tables 4 and 5 are metric-agnostic and provide additional evidence of each dimension's independent contribution. The important finding from Table 2 is that even removing a numerator component leaves the ranking well inside the random-re-ranking null (displacement 3.55 against a null median of 7.32), indicating the ranking pattern is overdetermined by the remaining dimensions. Third, the six non-DCI dimensions displace ranks by no more than 1.5 positions when removed individually, so their individual contributions to DCI ranking are marginal — as the denominator-only structure noted above predicts, and as a consequence of the index's definition rather than a discovery about those dimensions. It does not imply they carry no information (see Table 4 below).
...
Even at six dimensions, the ranking pattern remains highly stable. The lowest computable rho (.513, Ideological + Economic) reflects the removal of a DCI component plus the highest-variance non-DCI dimension. The most disruptive non-trivial removals all include either Economic or Semiotic. Removing any pair of soft dimensions preserves rho above .89, and the largest displacement over all 27 computable pairs (5.00) still falls below the random-re-ranking reference of 7.32; the accompanying cosines above .999 are again at the level unrelated vectors reach and are not read as evidence. The DCI ranking is structurally anchored by the hard-soft dimension boundary.
...
Result: Spearman rho = .9997 (p < .001), cosine = 1.000, mean rank displacement = .09.

That result is an algebraic identity, and reporting it as a finding would overstate it. The split preserves each parent dimension's total weight, so the denominator of DCI is unchanged; and both Economic halves are returned to the DCI numerator, so the numerator is unchanged as well. Every model's DCI is therefore the same number before and after the augmentation — verified to machine precision on a simulated 22-model panel, with a maximum absolute difference of $5.6 \times 10^{-17}$. No configuration of the split ratios, and no draw of the perturbation noise, could have produced any other outcome. The residual departure of rho from exactly 1.000 is a tie-handling artifact of the rank transform, not a change in any DCI value.

What Experiment 3 therefore establishes is that the augmentation code preserves weight, which is a worthwhile check on the implementation and is how it should be read. It does not address RQ2 as posed. Answering that question requires a genuinely new dimension carrying information absent from the eight — not a subdivision, which by construction re-partitions information already present — and no such dimension is tested here. RQ2 is accordingly recorded as unanswered rather than answered in the negative.
...
The share column cannot answer RQ3 on its own, and the reason is arithmetic. The eight percentages are shares of their own sum, so they necessarily total 100% and average 12.5%; a set of shares "all between 5% and 19%, none below 5.4%" is therefore not a finding about the dimensions but a statement that none of the eight is extreme relative to the other seven. To see whether the observed spread means anything, it has to be compared against what equally informative dimensions would produce. Simulating an exchangeable reference null — 22 models, eight dimensions of equal true variance, 100,000 draws — gives a median max/min share ratio of 2.40 with a 95% interval of $[1.55, 4.39]$, and a median spread between largest and smallest share of 10.6 percentage points. The observed ratio of 3.46 sits inside that interval ($p = .105$) and the observed spread of 13.3 points likewise ($p = .209$). The observed minimum share of 5.4% is, if anything, slightly below what the null typically produces ($p = .067$ in the lower tail).

RQ3 is therefore recorded as **not answered** by this decomposition rather than answered in the affirmative. The shares are consistent with all eight dimensions carrying comparable cross-model variance, and equally consistent with none of them carrying distinctive information; the statistic does not separate the two. A test that would separate them needs the raw per-model profile matrix and a within-model label permutation, which is left to the companion script at its next revision. What follows below does not depend on the share magnitudes. The six non-DCI dimensions (Cultural, Ideological, Narrative, Social, Experiential, Temporal — those not in the DCI numerator) collectively account for 49.2% of total cross-model variance. The dimensions that matter least for DCI ranking stability (Cultural 17.3%, Ideological 16.7%) carry the highest variance after Economic. Models agree on suppressing soft dimensions uniformly (the R15 H4 finding), but they disagree on *how much* to suppress Cultural and Ideological specifically. This variance does not appear in DCI because DCI aggregates only Economic and Semiotic — but it represents genuine inter-model perceptual heterogeneity that a reduced-dimension framework would lose.
...
Removing Ideological or Cultural *increases* mean pairwise cosine (from .976 to .980), revealing these dimensions as the primary sources of inter-model disagreement. Models agree most on Economic and Experiential weight assignments; removing this shared signal slightly reduces overall agreement. This analysis complements the variance decomposition: Cultural and Ideological contribute the most to *differentiating* models from each other (Table 4), while Economic and Experiential contribute the most to *aligning* models with each other (Table 5). A six-dimension framework omitting any two dimensions would therefore lose either differentiation power or alignment signal.

*Summary.* One of the three experiments answers its research question; the other two answer a narrower one than they were posed, and the summary says which is which. **RQ1** is answered: the DCI ranking is robust to dimension reduction, with every drop-one removal and every computable pair removal leaving rank displacement well below the random-re-ranking reference of 7.32 ($p < .001$ for all eight single drops; $p = .014$ for the worst pair), while each removal still sacrifices some information. The cosine floors of .994 and .993 are reported for completeness but carry no weight, being the values unrelated positive vectors of this dispersion already reach. **RQ2** is not answered: the ten-dimension expansion leaves DCI invariant as a matter of arithmetic, so the experiment functions as a check that the augmentation preserves weight, and a genuinely orthogonal dimension would be needed to test whether a richer taxonomy resolves more. **RQ3** is not answered either: the variance shares are shares of their own sum, and their observed dispersion is what eight exchangeable dimensions produce at this sample size.

What the three experiments do jointly support is narrower than a resolution limit and worth stating in its own terms: the cross-model DCI ranking is anchored by the hard-soft boundary, it is not an artifact of any single dimension, and the soft dimensions that matter least to it are the ones on which the models most disagree. The claim that eight is the resolution limit — that fewer sacrifices variance and more introduces redundancy — remains a conjecture motivated by the theoretical argument above rather than a result of these experiments, and the human-subject factor study named in the limitations is what would settle it.

*Companion Computation Script.* The full analysis in this section is reproducible from a single script. The analysis script `gap5_dimension_robustness.py` and the complete structured results `gap5_dimension_robustness_results.json` are archived at <https://github.com/spectralbranding/sbt-papers/tree/main/r11-dimension-justification/robustness-analysis>. The script uses fixed random seed `SEED = 42` (set via `np.random.seed(42)` immediately before the Experiment 3 augmentation step) so the noise-perturbed 50/50 splits in the 10D expansion are deterministic. With Python 3.12 and the `numpy` and `scipy` packages installed, the script reproduces Tables 2-5 of this section by running:
...
The three reference nulls introduced in this section are separate from that pipeline and are deliberately data-free, so that they can be checked without the source profiles. The random-re-ranking reference for mean absolute rank displacement is closed-form, $(n^2-1)/(3n) = 7.32$ at $n = 22$, with its interval obtained from 100,000 uniform permutations at seed 42. The cosine reference is the analytic expectation $m^2/(m^2+s^2) = .993$ for two independent positive vectors carrying DCI's own mean and standard deviation, confirmed over 200,000 simulated pairs. The exchangeable variance-share reference draws 22 observations on eight dimensions of equal variance, 100,000 times, and reports the resulting distribution of the max/min share ratio. The within-model label permutation that would test RQ3 directly needs the raw per-model profile matrix and is owed to the analysis script at its next revision; it is not reported here.
...
Theoretically, the taxonomy advances consumer research by offering a common language for phenomena previously studied in isolation: cultural meaning transfer [@mccracken-1986-culture-consumption-theoretical], iconic branding [@holt-2004-how-brands-become], experiential marketing [@schmitt-1999-experiential-marketing-how], and temporal aspects of brand heritage. It predicts, for example, that brands attempting ideological repositioning without narrative support will suffer coherence failure, and that temporal repositioning (heritage-to-innovation pivots) will be most disruptive for consumers high in nostalgia proneness. These predictions are now testable.

Practically, the framework enables new forms of brand tracking that capture not only overall equity but the specific channels driving it. Managers can diagnose whether a brand's weakness lies in semiotic clarity, experiential delivery, or cultural resonance — distinctions obscured by unidimensional or low-dimensional instruments. For global brands, the taxonomy highlights channels likely to vary cross-culturally (cultural, temporal, ideological) versus those expected to be more universal (semiotic, economic).

The argument proceeds in five steps. First, eight established academic traditions are enumerated — semiotics, narratology, ideology critique, phenomenology of experience, social identity theory, signaling theory, cultural sociology, and temporal psychology — each studying a distinct meaning-transmission channel relevant to brand perception. Second, dimensional independence is established by exhibiting, for each dimension, a pair of brands that differs primarily on that dimension while remaining approximately matched on the remaining seven. Third, non-redundancy and minimal completeness are demonstrated: five candidate ninth dimensions — aesthetic, functional, ethical, digital, and environmental — each reduce to components or combinations of existing dimensions rather than representing new meaning channels. Fourth, the apparent contradiction between SBT's eight dimensions and the two to three dimensions found by MDS is resolved: low-dimensional projections capture most variance (as concentration of measure predicts) while losing the profile-shape information that distinguishes coherence types. Fifth, an empirical robustness test using R15 cross-cultural LLM experiment data (22 models, 11,298 API calls) shows that every single-dimension removal, and every computable pair removal, leaves the cross-model DCI ranking far closer to baseline than a random re-ranking of the same 22 models would; the accompanying variance-share decomposition is reported as inconclusive, and the ten-dimension augmentation as the weight-preservation check it is.

Limitations remain. The current argument is primarily theoretical: while individual channels such as the temporal dimension now draw on converging domain-specific empirical evidence, large-scale human factor-analytic studies are still required to test whether the eight channels emerge as stable factors and whether they predict consumer outcomes beyond existing scales [@khamitov-2019-how-well-do]. The brand-pair illustrations, while illustrative, must be replaced by measured spectral profiles. Non-Western meaning systems may suggest alternative carvings that future work should incorporate.
