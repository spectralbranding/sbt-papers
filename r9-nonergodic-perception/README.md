...
![Last Updated](https://img.shields.io/badge/updated-2026--08--17-success)
...
@article{Zharnikov2026,
  ...
  title   = {From Order Effects to Absorbing States: A Non-Ergodic Framework for Multi-Dimensional Brand Perception Dynamics},
  year    = {2026},
  doi     = {10.5281/zenodo.19138860},
  url     = {https://doi.org/10.5281/zenodo.19138860},
  version = {2.3.0},
}
```
