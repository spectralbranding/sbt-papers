...
Combined Fisher chi-squared(6) = 69.06, *p* < .001. The J-shape is robust: mean distortion falls 49.4% from R1 (.172) to R2 (.087), and R1 exceeds R2 in every architecture tested.
