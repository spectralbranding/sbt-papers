...
Brand measurement collapses multi-dimensional perception into single scores, destroying the information that explains why different observers form irreconcilable perceptions of the same brand. Prior dimensional approaches decompose brand meaning into attribute-level dimensions but treat those dimensions as properties of the brand rather than perceptual channels through which heterogeneous observers filter signals. This paper develops Spectral Brand Theory (SBT), arguing that brand perception is irreducibly observer-dependent. The framework decomposes brand signals across eight perceptual dimensions, defines observer cohorts through formal spectral profiles, and models perception as probabilistic cloud formation that collapses into conviction through evidence accumulation. Five formal propositions address observer heterogeneity, non-ergodic perception, structural absence, coherence types, and conviction asymmetry. An illustrative application to five brands articulates four candidate mechanisms: structural absence as brand strategy, a five-type coherence taxonomy, asymmetric conviction resilience, and independence of brand power from brand health. Cross-model replication suggests structural conclusions are framework-driven rather than model-specific. SBT contributes a computationally implementable, observer-centric architecture that extends customer-based brand equity theory. A companion proof-of-concept study replicating SBT's cohort-divergence patterns across 17 LLM architectures confirms dimensional collapse as a systematic property of AI-mediated perception [@zharnikov-2026-dimensional-collapse-ai-mediated-search]; independent human-subject validation of the framework's propositions is the priority for future empirical work.

**Keywords:** brand perception, dimensional decomposition, computational branding, observer heterogeneity, brand coherence, structural absence, non-ergodic dynamics, AI-native framework, brand architecture, perceptual geometry
...
| Psychology | Factor analysis | Thurstone, Cattell |
| Economics | Multi-attribute utility | Lancaster, Fishbein & Ajzen |
| Consumer research | Conjoint analysis | Green & Srinivasan [-@green-1978-conjoint-analysis-consumer], Wilkie & Pessemier [-@wilkie-1973-issues-marketings-use] |
...
The framework contributes to branding theory in three ways. These contributions correspond to MacInnis's [-@macinnis-2011-framework-conceptual-contributions] Integrating and Advancing categories: contributions 1 and 2 integrate and formalize existing theoretical insights; contribution 3 advances the field by enabling computational implementations not previously achievable.
...
The remainder of this paper proceeds as follows. The theoretical framework comes first, culminating in five formal propositions that specify the framework's testable structural predictions. The illustrative application follows. The reported findings focus on four candidate mechanisms the application makes visible. The discussion then addresses implications, limitations, and future directions, before a concluding section.

**Table 2.** SBT Constructs and the Companion Papers That Formalize Them.

| SBT Construct | Companion Paper |
|:---|:---|
| Eight-dimensional brand space, metric structure | Zharnikov [-@zharnikov-2026-brand-space-geometry-formal-metric] |
| Observer cohort as cluster in spectral-profile space | Zharnikov [-@zharnikov-2026-cohort-boundaries-high-dimensional-perception] |
...
| Velocity, acceleration, and phase space of cohort drift | Zharnikov [-@zharnikov-2026z-spectral-dynamics] |
| Recovery threshold after coherence shocks | Zharnikov [-@zharnikov-2026-restoring-perceptual-separability-after-coherence] |
| AI observers as metameric class | Zharnikov [-@zharnikov-2026-dimensional-collapse-ai-mediated-search] |
| Multi-observer positioning geometry | Zharnikov [-@zharnikov-2026y-brand-triangulation] |
...
*Notes*: This table provides a reader entry point; Table 8 supplies the full formalization details for each construct. All companion papers are available open-access at the Zenodo community page (zenodo.org/communities/spectral-branding).

## Theoretical Framework

### Epistemic Foundation: Brands as Perceptual Objects
...
This inversion has a philosophical precedent. Peirce's semiotics, developed in the 1890s [@peirce-1931-1958-collected-papers], established that meaning arises in the interpreter, not the sign. Barthes [-@barthes-1957-mythologies] showed how cultural myths function as second-order semiotic systems that shape interpretation. Keller [-@keller-1993-conceptualizing-measuring-managing] located brand equity in the customer's mind. SBT formalizes and extends these insights into a computational architecture.

### Signal Architecture: Eight Perceptual Dimensions

SBT decomposes brand signals across eight dimensions, each representing a distinct channel through which observers perceive brand meaning (Table 3):
...
| **Social** | Community and status signals | Tribal markers, brand communities [@muniz-2001-brand-community-journal], peer signaling, status display [@veblen-1899-theory-leisure-class], exclusivity |
...
*Notes*: Dimensions measure brand output — signals emitted and how observers perceive them — not internal organizational process. Independence and non-redundancy of these eight dimensions is established formally in Zharnikov [-@zharnikov-2026-why-eight-completeness-necessity-sbt].
...
The eight dimensions emerged from a synthesis of prior frameworks. Kapferer's [-@kapferer-2008-new-strategic-brand] "physique" maps to the semiotic dimension; his "culture" maps to cultural and ideological; his "relationship" maps to experiential and social. Aaker's [-@aaker-1996-building-strong-brands] functional benefits map to experiential and economic; emotional benefits to social and cultural; self-expressive benefits to ideological and social. Holt's [-@holt-2004-how-brands-become] cultural branding theory maps to a combination of ideological and cultural dimensions, treating brands as cultural artifacts that derive meaning from their position in cultural discourse. De Chernatony & McDonald's [-@chernatony-2003-creating-powerful-brands] brand management framework similarly addresses the multi-faceted nature of brand meaning but treats the facets as brand properties rather than observer-dependent perceptual channels. Floch's [-@floch-1990-semiotics-marketing-communication] structural semiotics provides a complementary decomposition of the semiotic dimension, distinguishing practical, ludic, utopian, and critical valorizations that map to distinct sub-channels within SBT's semiotic-ideological space. Mick [-@mick-1986-consumer-research-semiotics] establishes the semiotic foundations for consumer research, demonstrating that brand signs operate through both denotative and connotative codes — a distinction SBT operationalizes through the designed/ambient signal classification. The temporal dimension — heritage and time-depth — appears in prior work as an attribute of specific brands but has not been modeled as a universal perceptual channel. Recent work confirms that these dimensions extend to emerging contexts: Pagani and Xie [-@pagani-2025-customer-experiences-branded] demonstrate that metaverse brand experiences produce measurable effects across awareness, associations, perceived quality, and loyalty — dimensions that map directly to SBT's experiential, social, and economic channels.

Each signal carries three properties:

- **Source type**: designed (created by the brand), ambient (generated by the environment — reviews, word-of-mouth transmission [@berger-2013-contagious-why-things], competitor framing, cultural commentary), or synthetic (AI-generated content, LLM summaries, algorithmic recommendations).
- **Emission type**: positive (signal actively present), null (unintentional absence), or structural absence (designed restriction that functions as a signal).
- **Strength**: rated 0–5, reflecting intensity of emission.

The signal concept extends economic signaling theory [@spence-1973-job-market-signaling] and its application to brand credibility [@erdem-1998-brand-equity-as; @kirmani-2000-no-pain-no] from a unidimensional quality indicator to a multi-dimensional perceptual architecture. Connelly, Certo, Ireland, and Reutzel [-@connelly-2011-signaling-theory-review] consolidate signaling theory across management disciplines — their review identifies signal observability, signal cost, and signal honesty as the three properties that determine signal effectiveness. SBT operationalizes all three: observability maps to the observer's spectral sensitivity (invisible dimensions produce no signal regardless of emission strength), cost maps to designed-versus-ambient classification, and honesty maps to the coherence between designed signals and the ambient signal field. Dawar and Parker [-@dawar-1994-marketing-universals-consumers] demonstrate that signal reliance varies systematically across cultures and product categories — evidence that the observer's context shapes which signals carry information, precisely the mechanism SBT formalizes through cohort-specific weight profiles. In SBT, a brand emits not one signal but a structured field of typed signals across eight dimensions — and the observer, not the market, determines which signals are informative.
...
### Observer Model: Spectral Profiles
...
The weight-based observer profile is structurally analogous to multi-attribute attitude models [@fishbein-1975-belief-attitude-intention], extending the attribute-weighting mechanism from product evaluation to perceptual dimensions with the critical additions of tolerances, priors, and the identity gate. The concept of observer-specific dimensional weights has its methodological precedent in the INDSCAL model [@carroll-1970-analysis-individual-differences], which demonstrated that individuals weight perceptual dimensions differently when evaluating stimuli — the same structural insight that SBT extends from laboratory stimuli to brand perception at the cohort level. Tversky's [-@tversky-1972-elimination-by-aspects] elimination-by-aspects model provides a complementary precedent for the identity-gate mechanism: choice is constructed by sequentially eliminating alternatives that fail on dimensions the observer treats as criterial, which formally entails that dimensions outside the observer's spectrum cannot enter the choice process at all — the structural condition SBT names as gate closure. The spectral profile determines not just *what* the observer sees but *how* they assemble what they see into meaning. Two observers exposed to identical signals will form different perception clouds if their weight profiles differ. This is not a failure of communication — it is the fundamental mechanism of brand perception.

**Formal observer model.** SBT defines each observer cohort through a spectral profile — a vector of dimensional weights, tolerances, priors, and gate states. Critically, cohorts are perceptual groupings, not demographic segments. Traditional segmentation variables — age, income, geography — are metadata: descriptive labels attached to the observer that may correlate with perceptual behavior but do not determine it. A cohort is a cluster in spectral-profile space: a group of observers whose profiles are similar enough that they form structurally similar perception clouds from the same signal environment. Two observers who share a demographic segment may belong to different SBT cohorts if their priors diverge — and two observers from entirely different demographics may share a cohort if their spectral profiles are similar. The distinction between a priori demographic segments and empirically discovered perceptual cohorts builds on the foundational segmentation methodology of Wedel and Kamakura [-@wedel-2000-market-segmentation-conceptual], who established latent class models as the standard for discovering unobservable consumer heterogeneity. Smith [-@smith-1956-product-differentiation-market] introduced market segmentation as a strategic construct; Yankelovich and Meer [-@yankelovich-2006-rediscovering-market-segmentation] subsequently argued that segmentation has become a primarily demographic exercise that fails to predict behavior — precisely because demographic variables are metadata about the observer, not measurements of the observer's perceptual apparatus. SBT's cohort construct addresses Yankelovich and Meer's critique directly: cohorts are clusters in perception space, not in demographic space, and two observers who share every demographic attribute may belong to different cohorts if their spectral profiles diverge. The clustering is a structural property of the observer population, not an analyst's modelling choice. The formal properties of cohort boundaries in high-dimensional perception space — including why they are inherently fuzzy — are derived in Zharnikov [-@zharnikov-2026-cohort-boundaries-high-dimensional-perception].

Cohort membership is dynamic. Because priors are a profile component and priors evolve through signal accumulation, decay, and crystallization, an observer's position in spectral-profile space shifts over time. Differential signal exposure — arising from encounter mode, geography, media consumption, and social networks — causes observers who once shared a cohort to drift apart as their priors diverge. Signal events (a CEO controversy, a product failure, a viral campaign) do not merely change perception — they physically redistribute observers across cohort boundaries. This dynamism distinguishes SBT cohorts from traditional market segments: segments describe who the observer *is*; cohorts describe how the observer *perceives*, and perception changes.

Figure 1 diagrams the full observer-mediated perception pipeline, from the shared signal environment through observer filtering to conviction and re-collapse; Figure 2 illustrates two Tesla cohorts forming opposite convictions from the same signal field.
...
**Stage 1: Cloud formation.** Perceived signals cluster in the observer's mind, weighted by the observer's spectral profile. The resulting cluster is a *perception cloud* — a probabilistic, pre-conviction impression. Clouds have valence (positive, negative, or ambivalent) — a measurable affective quantity in the tradition of human lexical affective norms [@warriner-2013-norms-valence-arousal] — and confidence (weak, moderate, or strong). The clustering mechanism draws on two established findings in consumer cognition: Alba and Hutchinson [-@alba-1987-dimensions-consumer-expertise] demonstrate that expertise and familiarity independently shape how consumers organize product knowledge — expertise determines the dimensions available for encoding (analogous to spectral sensitivity), while familiarity determines the density of stored associations (analogous to cloud confidence). Zajonc [-@zajonc-1980-feeling-thinking-preferences] establishes that affective responses can precede cognitive evaluation — cloud valence can form before the observer has consciously processed the dimensional content, particularly for semiotic and experiential signals that activate rapid affective encoding. Critically, clouds can form through direct encounter (experiential signals dominate) or through mediated channels (ideological, social, and narrative signals dominate, experiential signals absent). Mediated clouds tend toward lower confidence but can exhibit higher stability when no experiential data introduces ambiguity.
...
Coherence is measured through a seven-metric scorecard (Table 4):
...
*Notes*: All seven metrics are components of the spectral coherence audit conducted in Module 4 of the analytical pipeline. Grades range from A+ (highest) to F (lowest).

### Formal Propositions

The theoretical framework developed above generates five formal propositions that specify testable structural predictions. Each proposition formalizes an argument that the framework makes implicitly; stating them explicitly establishes the empirical commitments that distinguish SBT from a descriptive vocabulary.
...
Keller [-@keller-1993-conceptualizing-measuring-managing] locates brand equity in the customer's mind — the most important precedent for SBT's observer-dependent approach. The structural limitation of Keller's model is that it treats "the customer" as a single model: one set of brand associations, one equity structure. Keller acknowledged individual variation but did not parameterize it. SBT formalizes the heterogeneity that Keller's framework recognized but could not model, specifying the observer's spectral profile as the mechanism through which identical signals produce different convictions. Empirical evidence for observer-dependent brand perception already exists in the advertising literature. Grier and Brumbaugh [-@grier-1999-noticing-cultural-differences] demonstrated that identical advertisements produce systematically different meanings in target versus non-target cultural groups. Puntoni, Vanhamme, and Visscher [-@puntoni-2011-two-birds-one] documented "purposeful polysemy" — the deliberate design of messages that activate different meanings in different audiences — providing direct evidence that what SBT formalizes as spectral metamerism is an observed phenomenon in marketing practice. Testable prediction: measuring brand conviction across cohorts with documented spectral profile differences will reveal systematic, profile-predictable divergence rather than random variation.

*Falsification:* As first stated — that P1 fails if profile variation predicts no incremental variance in conviction beyond demographics — the falsifier could not fire. Priors are a component of the spectral profile, and an observer's prior about a brand is a lagged measure of that observer's conviction about it, so the outcome sits inside the predictor and a negative result is unobtainable by construction. The falsifier is therefore restated over the profile components that can be measured independently of any belief about the brand under test. P1 is falsified if cohorts differing measurably in dimensional weights, tolerances, and gate state — elicited through conjoint or behavioral instruments on stimuli other than the focal brand, with priors about the focal brand measured and held constant — produce conviction distributions that do not differ significantly after controlling for signal exposure. Under that specification a null is attainable, and it would show that the perceptual apparatus does no work once prior belief is held fixed.
...
Veblen [-@veblen-1899-theory-leisure-class] identified conspicuous consumption as a value-signaling mechanism; structural absence inverts this into conspicuous restriction. Commodity theory [@brock-1968-implications-commodity-theory] and the scarcity principle [@cialdini-2001-influence-science-practice] establish that scarcity enhances perceived value, but they treat scarcity as a unidimensional modifier; Hamilton et al. [-@hamilton-2019-effects-scarcity-consumer-decision] extend the account through a multi-stage consumer decision journey framework that maps scarcity effects across sequential choice stages, yet the mechanism remains single-dimensional. The structural limitation is that these accounts do not specify the cross-dimensional generation mechanism: restriction on one dimension (economic, experiential, social) produces a signal on a different dimension. The Hermès analysis presented below demonstrates that the brand's A+ coherence grade derives not from what it emits but from what it withholds. Testable prediction: comparing perceived value of brands with designed dimensional restriction against brands with equivalent positive signal strength will reveal a value premium attributable to restriction that cannot be replicated through addition.
...
These five propositions are not exhaustive predictions of SBT; they formalize the framework's most distinctive structural claims. The falsifiable hypotheses presented below operationalize these and additional predictions into specific experimental designs. Boundary conditions and scope limitations — including the Western-consumer bias of the illustrative application, the empirical status of the eight-dimension taxonomy, and the distinction between LLM and human observers — are discussed explicitly among the limitations and future directions.

## Proof-of-Concept Demonstration

The following section presents a structured demonstration applying SBT's analytical pipeline to five brands using large language models as analytical instruments — not as synthetic respondents substituting for consumer data. The purpose is to show that the framework's constructs operate coherently across brand archetypes; the four mechanisms identified are candidates for future empirical investigation, not validated findings.

### Design

To illustrate the framework's analytical architecture, we applied SBT to five brands selected to span the brand architecture space (Table 5). This application is a proof-of-concept demonstration rather than an empirical study: it shows how the framework's constructs operate in practice, not that the framework's propositions have been validated by consumer data.
...
*Notes*: All five brands are well-known global Western consumer brands. Applicability to non-Western, B2B, or newly launched brands is untested and identified as a limitation.

The five brands were chosen to stress-test different properties of the framework: Patagonia tests ideological filtering; Tesla tests extreme observer divergence and ambient signal dominance; IKEA tests consistent signal architecture at global scale; Hermès tests scarcity-based value creation and cross-cohort interdependence; Erewhon tests the framework's minimum viable scale and mediated perception dynamics. The current application is cross-sectional; longitudinal replication applying the full SBT pipeline to track dimensional activation and cohort divergence over a sustained campaign cycle is demonstrated for a single brand in Zharnikov [-@zharnikov-2026-dimensional-activation-cohort-divergence-longitudinal].
...
The pipeline was executed using Claude Opus 4.6 (Anthropic) as the primary analytical engine, with structured prompts and YAML output templates ensuring consistency across brands. An important methodological clarification: the LLMs serve as *analytical instruments* — structured reasoning engines that apply the framework's constructs to publicly available brand information — not as *synthetic respondents* simulating consumer perception (cf. [@brand-2023-using-gpt-market; @horton-2023-large-language-models; @goli-2024-frontiers-can-large] for the distinction between these two uses of LLMs in marketing research). The outputs reflect the framework's decomposition applied to public brand discourse, not predictions of how specific consumers would perceive these brands. A full cross-model replication was subsequently conducted using Gemini 3.1 Pro (Google) across all five brands to test for model-specific biases. Each module's output was assessed against four validation criteria: non-obvious (a brand strategist could not reach this through standard analysis), dimensionally specific (references specific dimensions and observer profiles), actionable (suggests concrete strategic changes), and observer-differentiated (shows how different cohorts perceive the same signals differently).

### Insight Validation Protocol

Each brand analysis was followed by a structured insight assessment that scored the top findings against the four criteria. An insight was recorded as accepted only if it satisfied all four simultaneously. Across five brands, 25 insights were scored by the framework's author, and all 25 were recorded as satisfying all four criteria.

That 25-of-25 count should not be read as a validation result, for three reasons that are properties of the procedure rather than of the findings. First, the insights scored were the ones already selected from each module's output as its top findings, so the denominator is a pre-filtered set rather than the full output. Second, the scorer was the author of the framework being scored, working without a blind or second rater. Third, two of the four criteria are guaranteed by the output format rather than earned by the analysis: the YAML templates require every module to name the dimensions and the observer cohorts it is reasoning over, so *dimensionally specific* and *observer-differentiated* cannot fail for any output the pipeline emits at all. At most two criteria — *non-obvious* and *actionable* — carry information, and both rest on a single non-blind rater.

The protocol is therefore reported here descriptively rather than as evidence. What it records is that the pipeline produced dimension- and cohort-specific output for all five brands, which is a statement about the output contract, and that the author judged that output non-obvious and actionable, which is an author judgment. The test that would carry evidential weight — independent blind scoring, by practitioners unfamiliar with the framework, of an unfiltered insight sample on the two informative criteria — has not been run. The four mechanisms reported below were selected as the most novel: candidate insights the author judged unavailable to existing brand frameworks for want of the necessary vocabulary.

### Limitations of the Illustrative Approach
...
To test for model-specific biases, a full cross-model replication was conducted using Gemini 3.1 Pro (Google) across all five brands (Table 6):
...
| Curved space, uniform observers | GR with test particles | SBT with homogeneous cohorts | Fisher-Rao metric [@zharnikov-2026-brand-space-geometry-formal-metric] describes geometry |
| Curved space, diverse observers | Electromagnetism in curved space | SBT with heterogeneous cohorts | Brand Triangulation [@zharnikov-2026y-brand-triangulation] needed |
...
*Notes*: GR = General Relativity. The correspondence is structural, not mathematical — brand perception does not obey the field equations of general relativity. The analogy names the regime hierarchy; the companion papers supply the formal treatment.
...
| Cohort as cluster in spectral-profile space | Zharnikov [-@zharnikov-2026-cohort-boundaries-high-dimensional-perception] | Concentration-of-measure analysis of cohort boundary fuzziness |
...
| Non-ergodic perception (P2) | Zharnikov [-@zharnikov-2026-non-ergodic-brand-perception-diffusion; -@zharnikov-2026-non-ergodic-brand-perception-why] | Stochastic differential equations on the simplex; absorbing states |
| Eight-dimension justification | Zharnikov [-@zharnikov-2026-why-eight-completeness-necessity-sbt] | Completeness and necessity argument for d = 8 |
| Coherence-type taxonomy (P4) | Zharnikov [-@zharnikov-2026-coherence-type-as-crisis-predictor] | Drift-geometry derivation of the five types |
...
| Re-collapse pipeline | Zharnikov [-@zharnikov-2026b-atom-cloud-fact-epistemological] | Atom-cloud-fact epistemological architecture |
| AI observers as metameric class | Zharnikov [-@zharnikov-2026-dimensional-collapse-ai-mediated-search] | Empirical metamerism across 17 LLM architectures |
| Multi-observer positioning | Zharnikov [-@zharnikov-2026y-brand-triangulation] | Brand triangulation — geometric multi-observer framework |
| Velocity / acceleration of cohort drift | Zharnikov [-@zharnikov-2026z-spectral-dynamics] | Phase-space dynamics in perception space |
...
| Portfolio interference and AI immunity | Zharnikov [-@zharnikov-2026-hf-r20-portfolio-ai-perception] | Spectral immunity of awareness-gated AI perception |
...
| Output (WHAT) vs. process (DO) layer | Zharnikov [-@zharnikov-2026-specification-impossibility-organizational-design-high; -@zharnikov-2026-organizational-schema-theory-test-driven] | OST L0 to L5 hierarchy; impossibility of complete process specification |
...
### Structural Absence: Value Creation Through Designed Signal Restriction
...
*Notes*: The distinction between null and structural absence is diagnostic: null absence is a potential strategic opportunity; structural absence is an intentional mechanism that requires heritage legitimization to function.

The key mechanism is cross-dimensional: restriction on one dimension generates a signal on a different dimension. Economic restriction (never discounting) produces a social signal — the product exists outside normal market forces, inverting Veblen's conspicuous consumption [@veblen-1899-theory-leisure-class] from display of spending to display of access. Experiential restriction (in-store purchase only) produces an economic signal (difficulty of access justifies the price). Social restriction (purchase rituals, relationship requirements) produces an experiential signal (the restriction process *is* the brand experience).

Structural absence amplifies the perceived weight of present signals through contrast — a multiplicative mechanism in perception rather than additive. Hermès achieves the highest emission efficiency in the study (9/10) not by optimizing what it sends but by optimizing what it withholds.
...
Traditional brand analysis treats coherence as a single variable from low to high: how consistently is the brand perceived across audiences? SBT instead treats coherence as a structural property with qualitatively distinct types, each carrying its own resilience profile (Table 10).

The status of the five types needs stating before the table is read. They are not a result recovered from the five-brand comparison. The five brands were selected one per type, precisely to span the architecture space the taxonomy names, and that assignment is the selection rationale printed in Table 5 — so the analysis returns five types because the sample was built to contain one instance of each. Table 10 reports the selection frame with resilience profiles attached to it. What the demonstration shows is that each type can be given a distinct resilience mechanism, and that the pipeline recovers the type it was handed a case of. What it cannot show is that five is the right number, that the types are exhaustive or mutually exclusive, or that the type of a brand not chosen for its type is recoverable at all. The derivation that carries the count is formal, not empirical: the five types are derived from drift-geometry analysis of the non-ergodic conviction dynamics in Zharnikov [-@zharnikov-2026-coherence-type-as-crisis-predictor]. Testing the taxonomy requires classifying brands that were not selected for it.
...
*Notes*: Grades reflect projected disruption resilience, not overall brand value. Brands with identical grades may have structurally different resilience mechanisms — this spectral metamerism is the substantive point of the coherence taxonomy. The five brands were selected one per type (Table 5), so the table displays the selection frame with resilience profiles attached rather than a classification independently recovered from the cases. The formal derivation of the five types from non-ergodic dynamics appears in Zharnikov [-@zharnikov-2026-coherence-type-as-crisis-predictor].

The letter grades are projections of multi-dimensional spectral profiles onto a disruption resilience scale. Different structural types can project to the same grade (spectral metamerism) — a brand with 7/10 signal coherence (IKEA: everyone perceives the same thing) and 7/10 ecosystem coherence (Hermès: different cohorts perceive different things that reinforce each other) would appear identical on a single-variable dashboard. Their responses to disruption are radically different. Sorensen [-@sorensen-2002-strength-corporate-culture] demonstrated across more than 200 firms that the structure of cultural alignment, not its intensity, determines outcomes; Chatman, Caldwell, O'Reilly, and Doerr [-@chatman-2014-parsing-organizational-culture] extended this by showing that consensus combined with adaptability outperforms consensus alone.
...
**Identity coherence** (Patagonia) exhibits binary resilience. The brand divides along ideological lines under stress. Aligned cohorts rally ("this proves they are authentic"). Misaligned cohorts deepen their indifference or opposition. The ideological core is either a magnet or a wall — there is no middle ground. Belk's [-@belk-1988-possessions-extended-self] extended-self framework provides the canonical mechanism: aligned cohorts incorporate the brand's ideological commitments into self-definition, so brand attack is read as identity attack and triggers defensive amplification rather than reassessment.
...
### Asymmetric Conviction Resilience
...
| **Experiential** | .35 (extensive product data) | .03 (no product contact) |
...
### Brand Power and Brand Health as Independent Variables

**Illustrative context:** Cross-brand comparison (Module 4 across all five brands).

The five-brand exploratory analysis produces a finding that inverts conventional brand wisdom: brand power (emission strength, awareness, cultural impact) and brand health (coherence, architectural integrity, resilience) are independent variables. A brand can maximize the first while minimizing the second (Table 12).
...
*Notes*: D/A = Designed/Ambient ratio (% designed signals / % ambient signals). Health grades reflect spectral coherence audit scores. Power is a relative assessment of dimensional emission breadth and identity-gate permeability across the five-brand sample. The 55–65% band discussed below is derived formally in Zharnikov [-@zharnikov-2026-non-ergodic-brand-perception-diffusion]; it is not supported by the rows above and is contradicted by them, since IKEA lies outside the band at 75% designed and carries the second-highest health grade in the sample (A-), ahead of Patagonia at 65% inside it (B+).
...
The D/A ratio is the metric that most sharply separates power from health across these five brands. Zharnikov [-@zharnikov-2026-non-ergodic-brand-perception-diffusion] derives a 55–65% designed-signal band mathematically, from the absorption-exploration tradeoff in the stochastic differential equation governing convictions on S⁷₊: high enough to maintain narrative control, low enough to allow authentic ambient reinforcement. The five-brand comparison neither establishes that band nor agrees with it. The band was drawn after these five observations were in hand, and Table 12 contradicts it — IKEA sits fifteen points above the ceiling at 75% designed and carries the second-highest health grade in the sample (A-), ahead of Patagonia at 65% inside the band (B+). With *n* = 5, one brand outside the band outgrading one inside it is enough to leave the band unsupported here. It stands or falls on the formal derivation and on the larger-sample test set out below as H1, not on this scatter.

What the five brands do support is weaker, one-sided, and confined to the low extreme. Tesla, at 30% designed, has 65% of its signal environment outside its own control, which is why the framework reads its problem as structural rather than communicational. Hermès, at 60% designed with *aligned* ambient signals, shows that the direction of ambient signals matters alongside the ratio: its ambient signals amplify rather than contradict its designed signals. Neither observation requires an optimum, and neither is disturbed by IKEA.
...
Aaker's [-@aaker-1991-managing-brand-equity; -@aaker-1996-building-strong-brands] brand equity and identity systems describe what the brand intends to emit but lack the observer model that explains why the same identity produces different perceptions in different cohorts. Aaker's four perspectives — Brand as Product, Organisation, Person, Symbol — each bundle multiple perceptual channels that SBT decomposes into eight parameterized dimensions. Kapferer's [-@kapferer-2008-new-strategic-brand] prism comes closest to SBT's dimensional approach, with its six facets mapping loosely to SBT's eight dimensions, but treats the facets as brand properties rather than observer-dependent perceptual channels. Keller's [-@keller-1993-conceptualizing-measuring-managing] customer-based brand equity is the most direct predecessor: equity lives in the customer's mind, brand knowledge equals awareness plus image. SBT extends Keller by modeling the customer as a heterogeneous population, formalizing the perception-to-conviction pipeline, and introducing the re-collapse mechanism. Existing dimensional approaches to brand perception — J. Aaker's [-@aaker-1997-dimensions-brand-personality] five personality dimensions, Kervyn, Fiske, and Malone's [-@kervyn-2012-brands-as-intentional] warmth-competence space, Brakus, Schmitt, and Zarantonello's [-@brakus-2009-brand-experience-what] four experience dimensions, Yoo and Donthu's [-@yoo-2001-developing-validating-multidimensional] multi-dimensional CBBE scale, and Keller's [-@keller-2001-building-customerbased-brand] brand resonance pyramid — each decompose brand meaning into measurable sub-constructs but treat the dimensions as brand attributes rather than observer-mediated perceptual channels (Table 13). SBT's contribution relative to these predecessors is not the dimensional decomposition itself but the formal parameterization of the observer as a first-class object whose spectral profile determines which dimensions are perceived and how they are weighted. Recent extensions — France, Davcik, and Kazandjian's [-@france-2025-digital-brand-equity] digital brand equity framework, Guhl's [-@guhl-2024-tracking-timevarying-brand] time-varying utility-based brand equity, and Lambrecht, Baumgarth, and Henseler's [-@lambrecht-2025-holistic-augmented-reality] augmented reality brand equity model — demonstrate growing recognition that brand equity is multi-dimensional and context-dependent; SBT provides the observer-mediated architecture within which these extensions operate.

**Table 13.** Eight SBT Dimensions Mapped to Predecessor Brand Frameworks.
...
Muniz and O'Guinn's [-@muniz-2001-brand-community-journal] brand community construct identifies the social dimension as a self-organizing perceptual system. Sharp's [-@sharp-2010-how-brands-grow] empirical challenge to brand differentiation is complementary rather than oppositional: Sharp describes acquisition (passing the identity gate widely); SBT describes what happens *after* the gate — how different observers form different convictions. The frameworks coexist within SBT's architecture as predictions about distinct regimes: Sharp's regularities (double jeopardy, near-identical buyer profiles across competing brands) hold when observer cohorts are spectrally homogeneous and competing brands occupy similar positions in perception space, so that mental availability dominates structural differentiation. SBT predicts that exactly these conditions produce Sharp's empirical pattern — and that the pattern weakens systematically as cohort heterogeneity rises (e.g., ideological brands like Patagonia, structurally polarized brands like Tesla, ecosystem brands like Hermès), where coherence type rather than mere availability becomes the dominant predictor of brand outcomes. Vargo & Lusch's [-@vargo-2004-evolving-new-dominant] service-dominant logic anticipated the co-creation premise; Merz, He, and Vargo [-@merz-2009-evolving-brand-logic] trace brand theory through four eras culminating in stakeholder co-creation, the trajectory SBT formalizes through parameterized observer profiles. Lakoff's [-@lakoff-2004-dont-think-elephant] cognitive frames provide a complementary mechanism: priors function as frames that pre-structure which signals are perceived as relevant.

Gestalt psychology [@koffka-1935-principles-gestalt-psychology] provides the perceptual foundations: cloud formation *is* gestalt perception applied to brand signals. Kahneman's [-@kahneman-2011-thinking-fast-slow] dual-process theory maps to the collapse mechanism: strong convictions are System 1 shortcuts; weak or forming clouds require effortful System 2 processing.
...
Peters' [-@peters-2019-ergodicity-problem-economics] ergodicity economics provides an organizing analogy. In multiplicative, path-dependent processes, ensemble averages diverge systematically from time averages [@doctor-2020-economists-views-ergodicity; @meder-2021-ergodicitybreaking-reveals-time]. SBT's finding that brand power (an ensemble measure) and brand health (a time-average measure) are independent variables is a structural parallel. The asymmetric conviction resilience finding reported earlier maps to absorbing states in non-ergodic processes: once a negative conviction crosses a threshold with no experiential friction to reverse it, the observer is on a one-directional trajectory. We use this analogy as an organizing framework, not as a claim that brand perception obeys the specific mathematical properties Peters demonstrates for wealth processes. The formal non-ergodic dynamics — including the stochastic differential equations on the perception simplex and the derivation of absorbing states from order effects — are developed in Zharnikov [-@zharnikov-2026-non-ergodic-brand-perception-diffusion] and Zharnikov [-@zharnikov-2026-non-ergodic-brand-perception-why].

Attitude strength research [@krosnick-1995-attitude-strength-overview] establishes that strong attitudes resist change. SBT extends this by specifying the dimensional pathway: evidence-free convictions resist counter-evidence because the observer's spectral profile excludes the dimensions where counter-evidence exists. Commodity theory [@brock-1968-implications-commodity-theory] and scarcity research [@cialdini-2001-influence-science-practice; @hamilton-2019-effects-scarcity-consumer-decision; @lynn-1991-scarcity-effects-value] establish that scarcity enhances perceived value. SBT's structural absence mechanism formalizes the cross-dimensional generation pathway and its prerequisites (existing demand and heritage context).

SBT does not capture everything existing frameworks do. Sharp's [-@sharp-2010-how-brands-grow] empirical regularities — double jeopardy, negative binomial distribution of purchase frequency — describe aggregate market-level patterns that SBT's cohort-level architecture does not address; these phenomena may emerge from the cohort dynamics SBT models but the framework does not predict them. Similarly, the rich phenomenological detail of Fournier's [-@fournier-1998-consumers-their-brands] relationship theory — brand relationships as lived narratives — is reduced to parameter values in SBT's observer profiles. The framework trades phenomenological richness for computational tractability.

The coherence-type finding carries a specific managerial implication that single-score dashboards cannot deliver: the optimal response to brand disruption differs categorically by coherence type. An ecosystem-coherent brand (Hermès) should let peripheral cohorts exit rather than defend against disruption — purification strengthens the core. A signal-coherent brand (IKEA) must respond system-wide because damage transmits uniformly — targeted cohort management is futile. An identity-coherent brand (Patagonia) should double down on its ideological core under stress rather than moderate — the binary response pattern means moderation satisfies neither aligned nor misaligned cohorts. These recommendations are reversed from what a single coherence score would suggest: all three brands score comparably on aggregate coherence, but the correct crisis strategy differs in direction, not just degree.

In sum, SBT contributes a unifying vocabulary that connects the sender-side frameworks (Aaker, Kapferer), receiver-side frameworks (Keller), acquisition frameworks (Sharp), and process frameworks (cognitive science, ergodicity economics) as complementary descriptions of different stages in a single perception pipeline. The formal criterion for construct validity — that variation in the attribute causally produces variation in the measurement outcome [@borsboom-2003-theoretical-status-latent] — is satisfied by spectral profiles only when the instrument preserves dimensional structure. Aggregated metrics fail this criterion by design. Each limitation discussed below has a companion-paper formalization: cohort boundary fuzziness in high-dimensional perception space [@zharnikov-2026-cohort-boundaries-high-dimensional-perception], non-ergodic conviction dynamics [@zharnikov-2026-non-ergodic-brand-perception-why], the Dove longitudinal case [@zharnikov-2026-dimensional-activation-cohort-divergence-longitudinal], spectral dynamics including decay rates and cohort velocity [@zharnikov-2026z-spectral-dynamics], and the mathematical treatment of conviction recovery after coherence shocks [@zharnikov-2026-restoring-perceptual-separability-after-coherence]. The spectral resource allocation question — where to invest given measured cohort weight profiles — is addressed in Zharnikov [-@zharnikov-2026-spectral-resource-allocation-demand-driven].

### Computational Implementability

The closest computational precedent is Colladon's [-@colladon-2018-semantic-brand-score] Semantic Brand Score (SBS), which extracts three network-based dimensions from text data. SBS measures brand *importance* in discourse networks — a salience metric. SBT measures brand *perception* across eight qualitative dimensions — a content metric. More broadly, the emerging computational branding literature — including Barari and Eisend's [-@barari-2024-computational-content-analysis] computational content analysis and Sarstedt, Brand, Ringle, and Dolz's [-@sarstedt-2024-using-large-language] investigation of LLMs as survey respondents — demonstrates growing recognition that brand analysis can be formalized and automated. Nguyen [-@nguyen-2026-evaluating-efficacy-aigenerated] provides cross-national evidence that AI-generated advertising produces measurable effects on brand perception, further validating the computational approach. SBT extends this trajectory from computational *measurement* of existing constructs to computational *execution* of a formal perceptual theory.
...
### The WHAT Layer: SBT Dimensions as Output Specification
...
This distinction has antecedents in three organizational literatures that converge on the same cut. Mintzberg [-@mintzberg-1979-structuring-organizations-synthesis] draws it as the difference between standardization of outputs — specifying what must be produced — and standardization of work processes — specifying how production must proceed. Iyer, Schwarz, and Zenios [-@iyer-2001-screening-contracts-product] formalize the same cut in screening contracts as product specification versus process specification: what the downstream party is obligated to deliver versus the procedures governing delivery. Adler and Borys [-@adler-1996-two-types-bureaucracy] frame it normatively as enabling versus coercive bureaucracy — a specification that exists to serve the worker's judgment versus one that substitutes for it. Across organizational theory, contract economics, and management practice, the same boundary reappears: *what* the system outputs versus *how* the system operates to produce that output. SBT occupies one side of this boundary consistently.

Organizational Schema Theory (OST; Zharnikov [-@zharnikov-2026-organizational-schema-theory-test-driven]) makes the two-layer structure explicit. OST's L0–L1 layers define customer experience contracts and signal requirements — the output specification that SBT measures. Its L3–L5 layers define coordination procedures, workflows, and operational steps — the process specification that SBT deliberately excludes. Neither framework addresses the other's layer in isolation: OST specifies the WHAT; SBT measures whether the WHAT was perceived.

The R5 impossibility result [@zharnikov-2026-specification-impossibility-organizational-design-high] gives this boundary formal weight. Work-process standardization cannot be completed: the operational space of a modern organization is sufficiently high-dimensional that no finite set of standard operating procedures closes it — there will always be contingencies the SOP does not cover. Output standardization, by contrast, is decidable: a finite acceptance test on eight perceptual dimensions can verify whether the target perception was achieved. The WHAT is finite because it is defined at the observer's cognitive interface; the DO is unbounded because it must enumerate a causal chain through the full complexity of organizational execution.

AI-mediated channels make the distinction empirically observable. R15 [@zharnikov-2026-dimensional-collapse-ai-mediated-search] shows that large language models systematically collapse the coordination-related dimensions — Cultural, Temporal, Social — while preserving the output-related dimensions — Economic, Semiotic. The collapsed dimensions are precisely those that encode how a brand is embedded in social and temporal context; the preserved dimensions are those that encode what the brand delivers and signals about value. R21 [@zharnikov-2026-hf-r20-portfolio-ai-perception] extends this result to the portfolio level: corporate ownership — an organizational coordination fact — predicts near-zero variance in AI perception of member brands (*d* ≤ .18 across all ownership conditions), while dimensional alignment at the output layer predicts the interference patterns that do emerge. The AI channel, by stripping coordination context, isolates the WHAT signal.
...
The AI era changes brand perception in three ways that SBT's architecture accommodates. First, **AI as analytical engine**: LLMs can execute multi-dimensional, multi-cohort brand analysis that would overwhelm human cognition, making frameworks of SBT's complexity operational. Second, **AI as mediation layer**: algorithms increasingly filter which signals reach which observers — an extension of McLuhan's [-@mcluhan-1964-understanding-media-extensions] thesis — functioning as spectral filters with their own dimensional biases. Third, **AI as synthetic observer**: LLM-powered recommendation systems constitute a new observer class with their own spectral profile (biased toward economic and semiotic signals, weak on narrative, cultural, and temporal dimensions; Zharnikov [-@zharnikov-2026-dimensional-collapse-ai-mediated-search]), increasingly influencing human purchase decisions.

These shifts are recognized in the emerging literature. Davenport, Guha, Grewal, and Bressgott [-@davenport-2020-how-artificial-intelligence] identify AI as transforming marketing from segmented to individualized. Huang and Rust [-@huang-2021-strategic-framework-artificial] predict which marketing functions AI will subsume. Puntoni, Reczek, Giesler, and Simester [-@puntoni-2021-consumers-artificial-intelligence] analyze how consumers experience AI as threatening to their autonomy — perceptual reactions that SBT models as observer-profile shifts in the ideological and social dimensions. The observer model's encounter modes (direct, mediated, mixed) and the signal taxonomy's synthetic source type accommodate these developments without retrofitting.

Supplementary experiments provide initial empirical grounding for these predictions. A simulated 3-step agentic shopping pipeline (retrieval, comparison, recommendation) across 6 LLM architectures showed that dimensional collapse compounds across pipeline steps (*F* = 4.298, *p* = .015, η² = .029), with Narrative and Cultural dimensions losing the most weight while Economic gains (Zharnikov [-@zharnikov-2026-dimensional-collapse-ai-mediated-search], agentic pipeline experiment). The compounding effect is small but systematic — no model-specific differences were observed (*p* = .152) — suggesting that collapse is an architectural property of statistical language modeling, not an artifact of any particular training corpus.

### Limitations and Future Directions

Several limitations warrant discussion. The open questions identified below concerning non-ergodic dynamics, cohort boundary formalization, and resource allocation now have formal mathematical treatment in the companion papers described earlier. The limitations discussed here concern empirical validation, which remains for future work.

**Computational observer validity.** SBT operates within the emerging computational-marketing tradition that uses LLMs as analytical instruments [@brand-2023-using-gpt-market; @argyle-2023-out-one-many]. More directly, the computational-social-science literature establishes LLMs as competent zero-shot text annotators that match or exceed trained crowd workers on classification tasks such as stance, topic, and frame detection [@gilardi-2023-chatgpt-outperforms-crowd; @ziems-2024-can-large-language-models] — the specific capability the framework relies on when an LLM reads a public artifact and scores it on the eight dimensions. This tradition is contested: Goli and Singh [-@goli-2024-frontiers-can-large] document systematic divergences between LLM and human preferences. Cross-cultural replication in Zharnikov [-@zharnikov-2026-dimensional-collapse-ai-mediated-search] shows that LLM cohorts share a structural Economic-Default bias absent in human samples. SBT does not assume LLMs and humans are interchangeable observers; rather, the framework's observer-parameterization makes the divergence itself measurable, converting a methodological complication into a primary observation about how different observer types perceive the same signal environment.
...
**Temporal dynamics.** The framework captures snapshots but does not formally model rates of change. Two temporal properties require formalization: (1) *signal decay* — how signal contributions attenuate over time, varying by emotional intensity and encounter mode; and (2) *cohort velocity* — conviction migration speed for longitudinal tracking. Du and Kamakura [-@du-2015-improving-statistical-performance] demonstrate that dynamic factor analysis can separate true brand movement from measurement drift — a methodology applicable to cohort-level velocity aggregation in the spectral setting. The formal treatment of both properties — including velocity, acceleration, and phase-space representations of cohort trajectories — is developed in Zharnikov [-@zharnikov-2026z-spectral-dynamics].

**Competitive analysis.** An empirical test of competitive interference across 5 focal brands paired with direct, adjacent, and distant competitors found null effects on all hypotheses (largest *d* = .187, all *p* > .05 after Bonferroni correction; Zharnikov [-@zharnikov-2026-many-brands-can-market-hold], competitive interference experiment). Brands occupy stable positions in perception space regardless of competitive context, supporting the fixed-geometry assumptions of the framework. The limitation remains that these tests used LLM observers only; human-subject competitive interference remains untested.

**Temporal compounding.** Heritage compounds non-linearly. Urde, Greyser, and Balmer [-@urde-2007-corporate-brands-with] formalize brand heritage as a strategic resource; Brown, Kozinets, and Sherry [-@brown-2003-teaching-old-brands] demonstrate through retrobranding that heritage signals can be deliberately reconstructed. Taleb's [-@taleb-2007-black-swan-impact] analysis of path-dependent processes provides a framework for modeling how small early signals compound into structural priors that resist correction — the non-ergodic dynamics formalized in Proposition 2.

**Non-ergodic dynamics.** Brand perception operates as a multiplicative, path-dependent process, making it structurally non-ergodic in Peters' [-@peters-2019-ergodicity-problem-economics] sense. Introducing an ergodicity coefficient per brand-dimension pair — measuring the degree to which ensemble metrics reliably predict individual cohort trajectories — would identify which dimensions can be safely measured with aggregate surveys and which require longitudinal cohort-trajectory tracking.
...
```
  ...
  +---------------------------+   +---------------------------+
  | H1: D/A band              |   | H6: Gate Friction         |
  |     55-65% designed opt.   |   |     Varies by cohort      |
  | H2: Asymmetric Resilience |   | H7: First-Signal Primacy  |
...
Four boundary conditions define the validated scope of the SBT framework and distinguish cases where the architecture applies from cases where structural extension is required before deployment.

**Brand type.** SBT has been developed and illustrated against corporate and commercial consumer brands — organizations that emit multi-dimensional signals to observer cohorts in competitive markets. Place brands, person brands, and NGO brands share surface features (signal emission, observer cohorts, perception clouds) but differ structurally: place brands cannot control their semiotic and experiential dimensions to the degree commercial brands can; person brands collapse narrative and social dimensions onto a single individual, creating a temporal fragility not present in institutional brands; NGO brands operate in an ideological dimension space where the economic dimension may be absent or inverted. The eight-dimension architecture is structurally extensible to these cases, but dimensional weights, gate mechanisms, and coherence type definitions may require recalibration. Applicability outside the validated commercial-brand scope is untested and identified as a priority for future work.

**Observer cohort specification.** SBT's perception pipeline is well-defined when observer cohorts can be characterized through measurable spectral weight vectors. Cohorts are empirically discoverable through conjoint analysis, behavioral experiments, or spectral clustering of survey responses [@zharnikov-2026-cohort-boundaries-high-dimensional-perception]. The framework is under-specified for unbounded one-off observers — individuals whose spectral profile is unique and cannot be grouped into a recurring cohort. In practice, most commercial brand contexts involve recurring observer types, making this a tractable constraint; emerging AI-mediated contexts, where each LLM architecture constitutes a distinct singleton observer, require the multi-observer geometric treatment developed in Zharnikov [-@zharnikov-2026y-brand-triangulation].

**Measurement instruments.** The eight-dimensional profile requires a validated psychometric instrument to move from exploratory application to confirmatory research. For AI observers, the PRISM-B instrument operationalizes dimensional scoring through structured elicitation protocols validated across 17 LLM architectures [@zharnikov-2026-dimensional-collapse-ai-mediated-search]. For human observers, PRISM-H is under development per the R11/R24 research plan [@zharnikov-2026-why-eight-completeness-necessity-sbt]; until that instrument is validated, human-observer weight profiles remain expert estimates rather than measured quantities. This instrument gap is the primary methodological limitation on empirical progress and the highest-priority near-term research task in the SBT program.

**Temporal scale.** The static eight-dimensional profile is well-defined at any moment in time. Dynamic claims — how a brand's spectral profile evolves, how cohort velocities respond to signal events, how conviction recovery unfolds after coherence shocks — require the SDE machinery developed in the companion papers (Zharnikov [-@zharnikov-2026-non-ergodic-brand-perception-diffusion; -@zharnikov-2026z-spectral-dynamics]) and a cohort-stable measurement window of approximately one to two quarters. Shorter windows conflate measurement noise with true cohort drift; longer windows without interim measurement lose the signal-event attribution needed to identify causal drivers. Researchers designing longitudinal SBT studies should treat the measurement-window length as an explicit design parameter, calibrated against the signal-event frequency in the target brand's environment.
...
The five formal propositions and ten falsifiable hypotheses establish a concrete research agenda spanning cross-sectional brand studies, controlled signal-sequence experiments, and longitudinal cohort tracking. The proof-of-concept demonstration across five brands shows that the framework's constructs operate coherently across luxury, mass-market, mission-driven, technology, and hyperlocal categories. Independent human-subject validation of the propositions — particularly P2 (non-ergodicity) and P5 (conviction asymmetry) via conjoint-based spectral weight measurement — is the most important next step before the framework can claim empirical support beyond its theoretical derivation.
