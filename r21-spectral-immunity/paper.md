...
**Keywords:** spectral immunity, brand portfolio, awareness gate, portfolio interference, large language models, TOST equivalence, cross-cultural AI

---

Brand portfolio theory has since Aaker and Joachimsthaler [-@aaker-2000-brand-leadership] classified portfolios by architecture — how brands are organized by the firm — without formalizing how brands interact in the observer's perception space. A consumer who discovers that Dove and Axe share a parent entity may experience a shift in brand perception: Axe's historically objectifying advertising may contaminate Dove's empowerment positioning. Keller [-@keller-1993-conceptualizing-measuring-managing] formalized this through customer-based brand equity, where corporate associations transfer to subsidiary brands via associative network activation. Erdem and Sun [-@erdem-2002-empirical-investigation-spillover] modeled the mechanism as umbrella signaling, showing that advertising signals from one product under an umbrella brand affect beliefs about siblings. Lei, Dawar, and Lemmink [-@lei-2008-negative-spillover-brand] demonstrated that portfolio spillover is asymmetric: negative effects propagate more strongly from weaker to stronger brands.

The *awareness gate* is the central moderator in all existing accounts. Interference requires the observer to recognize shared corporate ownership. For LLMs — an increasingly consequential class of brand observer [@li-2024-frontiers-determining-validity; @brand-2023-using-gpt-market; @hermann-2025-empowering-genai-stakeholders; @dubois-2025-forget-what-you] — the awareness gate is permanently saturated. LLMs cannot be manipulated into "not knowing" that Dior belongs to LVMH. The information is encoded in their parameters. This extension of the awareness-gate prediction to AI observers — a class for which no prior portfolio theory has derived predictions — creates what we term the *awareness gate paradox*. If interference scales with awareness (as standard portfolio theory predicts for human observers), LLMs should exhibit permanent maximal interference. Alternatively, if LLM brand encodings are already compressed to near-minimum-distortion representations, adding portfolio context provides no additional information the encoding can absorb. These competing predictions — maximal interference versus complete immunity — are testable.

The human-sample literature offers a clear baseline. Peng et al. [-@peng-2023-metaanalysis-brand-extension] meta-analyzed three decades of brand extension research across 2,134 effect sizes, establishing that positive spillover effects operate reliably under conditions of common-ownership awareness. By contrast, we find near-zero portfolio-induced change for AI observers (mean $|\Delta\text{DCI}|$ = .26, TOST equivalence for 18/20 brands). This is a qualitative departure from the human-sample consensus, consistent with a fundamentally different encoding mechanism rather than a quantitative difference of degree.

This paper makes three contributions. First, we formalize the spectral interference mechanism within multi-dimensional perception space, deriving three testable propositions about the conditions under which portfolio interference operates (Theoretical Framework). Second, we provide the first systematic test of portfolio-archetype-graded interference across AI observers, with 9,925 observations across 40 brands, 13 models from seven training traditions, seven portfolio archetypes, and four prompt modalities, including direct rating, naturalistic recommendation, multi-turn conversation, and native-language framing (Method, Results). Third, we resolve the awareness gate paradox by introducing a bandwidth constraint: the awareness gate is necessary but not sufficient for interference; a perception channel with adequate capacity to encode portfolio context is also required (Discussion). The three propositions — interference conditionality (P1), awareness gate sufficiency inversion (P2), and interference asymmetry (P3) — are tested sequentially, with H5 (spectral immunity) as the headline empirical claim.

This paper consolidates the theoretical framework [@zharnikov-2026-hf-r20-portfolio-ai-perception] and large-scale empirical test [@zharnikov-2026-does-corporate-ownership-matter-ai] of portfolio interference into a unified treatment, formalizing the awareness-gate sufficiency inversion that neither precursor isolated.
...
The dominant framework for brand portfolio management derives from Aaker and Joachimsthaler [-@aaker-2000-brand-leadership], who proposed the brand relationship spectrum from branded house to house of brands. Keller [-@keller-1993-conceptualizing-measuring-managing; -@keller-2008-strategic-brand-management] advanced the field by modeling equity transfer within portfolios, though his customer-based brand equity model treats brand equity as a unidimensional construct. This tradition descends from Aaker [-@aaker-1991-managing-brand-equity], which framed brand equity as a stable, transferable corporate asset; the spectral-immunity construct departs from it by treating perceived brand identity as observer-completed rather than firm-owned, so that what an asset-based account would predict to propagate across a portfolio instead remains confined to the brand whose output the observer reconstructs. The canonical model of the coherence that portfolios are designed to protect is Kapferer's [-@kapferer-2008-new-strategic-brand] brand-identity prism; the immunity result implies that for AI observers this prescribed coherence is encoded at the individual-brand level and is not perturbed by disclosure of the portfolio relationships the prism organizes.

The portfolio interference literature can be read as a lineage of escalating awareness-gate claims. Keller [-@keller-1993-conceptualizing-measuring-managing] established the gate as a necessary trigger: associative-network activation requires the observer to recognize shared corporate ownership. Erdem and Sun [-@erdem-2002-empirical-investigation-spillover] modeled the gate as an amplifier: umbrella advertising signals propagate quality beliefs to sibling products in proportion to ownership awareness. Lei et al. [-@lei-2008-negative-spillover-brand] demonstrated that the gate operates asymmetrically: negative spillover propagates more strongly from weaker to stronger brands than the reverse. Peng et al. [-@peng-2023-metaanalysis-brand-extension] meta-analyzed three decades of brand extension research across 2,134 effect sizes, confirming that gate-dependent positive spillover operates reliably across diverse portfolio and product contexts. The present paper is the first to test gate *sufficiency* directly, using LLMs as observers for whom awareness is permanently saturated.

The brand extension literature also established that cross-brand association transfer is moderated by perceived fit [@aaker-1990-consumer-evaluations-brand; @vlckner-2006-drivers-brand-extension], brand breadth [@meyvis-2004-when-are-broader], and portfolio size and quality [@dacin-1994-effect-brand-portfolio]. Reciprocal spillover — where extensions influence beliefs about the parent and siblings — was documented by Balachander and Ghose [-@balachander-2003-reciprocal-spillover-effects]. The most recent portfolio coherence scale was developed by Nguyen, Zhang, and Calantone [-@nguyen-2018-brand-portfolio-coherence], and Ward et al. [-@ward-2026-keeping-it-family] identified consistency in symbolism and user imagery as primary drivers of portfolio brand cohesion, findings we use to contextualize our archetype predictions. That meta-analytic consensus serves as the human-sample benchmark against which the AI null result reported here is evaluated: the absence of the expected spillover in AI observers is not a small-sample anomaly but a systematic departure from a literature with 2,134 observations of the opposite pattern.

The closest existing formal approach to cross-brand perceptual interaction derives from information economics. Erdem and Swait [-@erdem-1998-brand-equity-as] formalized brand equity as a signaling phenomenon. Erdem and Sun [-@erdem-2002-empirical-investigation-spillover] empirically modeled umbrella branding spillovers, finding that positive umbrella signals increase quality expectations for sibling products. Miklos-Thal [-@miklosthal-2012-linking-reputations-through] proved game-theoretically that umbrella branding can only credibly signal positive quality correlation. The most recent formal model is Ke, Shin, and Yu [-@ke-2022-model-product-portfolio], who modeled product portfolio positioning as a mechanism to guide consumer search on a Hotelling line. Their framework optimizes *where to position* brands to influence consumer search outcomes; the spectral framework predicts *what happens perceptually* after brands are positioned. The two frameworks are therefore complementary — Ke et al. address search behavior consequences, this paper addresses perception-space consequences. Yu [-@yu-2021-model-brand-architecture] models optimal brand architecture choice based on supply- and demand-side relatedness; the present study tests whether the perceptual consequences of that choice operate for AI observers.

Three unaddressed gaps characterize this literature. First, no existing framework formalizes how brands interact across multiple independent perceptual dimensions simultaneously. Second, existing models assume observer homogeneity — the "average consumer" — rather than accounting for heterogeneous weight vectors that cause the same portfolio to be coherent for one cohort and contradictory for another. Third, no framework has tested whether portfolio interference operates for AI observers, who differ from human observers in having permanently saturated awareness gates.

***AI as Brand Observer***

LLMs increasingly mediate consumer access to brand information through search, recommendation, and conversational interfaces. Li et al. [-@li-2024-frontiers-determining-validity] validated LLMs as brand perception instruments, achieving over 75% agreement with human perceptual data, establishing a methodological foundation for using LLMs as synthetic respondents. This rests on a broader computational-social-science finding that LLMs are competent zero-shot text annotators, matching or exceeding trained crowd workers on text-classification tasks such as stance, topic, and frame detection [@gilardi-2023-chatgpt-outperforms-crowd; @ziems-2024-can-large-language-models]. Where Li et al. [-@li-2024-frontiers-determining-validity] validated LLMs as brand-perception instruments demonstrating 75%+ agreement with human perceptual data, the present paper tests the boundary of that validity: LLM brand profiles are valid representations of brand output characteristics but are invariant to organizational-coordination manipulations, suggesting that AI-instrument validity is WHAT-layer validity, not DO-layer validity. Brand, Israeli, and Ngwe [-@brand-2023-using-gpt-market] demonstrated that LLM-based systems can generate market research outputs that parallel survey-based methods at scale, establishing a methodological precedent for using LLMs as synthetic respondents in brand perception studies. Arora, Chakraborty, and Nishimura [-@arora-2025-aihuman-hybrids-marketing] established reliability and validity benchmarks for AI-human hybrid marketing research. Hermann and Puntoni [-@hermann-2025-empowering-genai-stakeholders] argued that understanding how LLMs structure brand-related outputs is now a strategic priority, framing AI influence as a domain that requires formal treatment rather than ad hoc intuition. Dubois, Dawson, and Jaiswal [-@dubois-2025-forget-what-you] extend this framing with the concept of "Share of Model" — the proportion of AI-mediated interactions in which a brand is positively featured — as an emerging strategic resource distinct from traditional share of voice. We reference this framing in the Managerial Implications section. Sabbah and Acar [-@sabbah-2026-marketing-machines-how] showed that only quantitative ratings are stable across LLM models, suggesting that compressed scalar representations survive cross-model variation while relational context does not — directly relevant to the bandwidth constraint formalized in Proposition 2. Where Goli and Singh [-@goli-2024-frontiers-can-large] documented structural divergence between LLM and human preferences in choice tasks, attributing it to training-distribution differences, the present paper attributes the divergence under portfolio-context manipulation to a bandwidth constraint: AI observers do not merely process different information — they are structurally incapable of propagating organizational-coordination context into perceptual encodings regardless of their awareness of that context.

Existing LLM brand perception studies have validated AI instruments against human perceptual data [@li-2024-frontiers-determining-validity] and documented structural divergence [@goli-2024-frontiers-can-large], but none have tested whether AI instruments are equally valid for WHAT-layer versus DO-layer information. The present paper is the first to draw this distinction systematically: AI brand profiles are valid representations of brand output characteristics but are invariant to organizational-coordination manipulations. This WHAT-layer validity / DO-layer invariance framing is this paper's specific contribution to the LLM-as-observer camp.
...
A high DCI indicates a profile concentrated on one or two dimensions; a low DCI indicates balanced dimensionality. This generalizes the two-dimension form introduced in Zharnikov [-@zharnikov-2026-dimensional-collapse-ai-mediated-search], $DCI_{R15} = (w_{Economic} + w_{Semiotic}) / 100$, which was specialized to the AI Economic Default mechanism (uniform baseline $.250$, where $w_d$ is on a 0--100 scale). The 8-dimension L1 form used here measures total concentration regardless of which dimensions absorb the mass; the two definitions coincide on the special case where only Economic and Semiotic are weighted above baseline.
...
Equations (3) and (4) model the *potential* perturbation given awareness $\alpha$. Realization requires that the observer's encoding has sufficient representational capacity to propagate the interference term into observable brand profiles. Rate-distortion theory [@cover-2006-elements-information-theory] formalizes this constraint: an encoder operating at the rate-distortion frontier minimizes representation cost subject to a maximum distortion bound. At this frontier, additional information cannot alter the encoded output unless it reduces distortion — i.e., unless it is structurally relevant to the dimensions being encoded. Portfolio membership (DO-layer information) communicates organizational structure, not output characteristics. A rate-distortion-optimal encoder that targets output fidelity will discard this signal.

Rational inattention [@sims-2003-implications-rational-inattention] provides the formal behavioral tradition from which the bandwidth constraint derives. Sims established that agents with finite information-processing capacity solve a constrained optimization problem: allocate attention across signals to maximize expected utility subject to a mutual information budget. Matejka and McKay [-@matejka-2015-rational-inattention-discrete] showed that the optimal solution in discrete-choice settings is the multinomial logit model, tying RI directly to empirically tractable preference structures. Caplin and Dean [-@caplin-2015-revealed-preference-rational] extended RI to revealed-preference and perceptual contexts, demonstrating that the RI framework applies wherever an observer must map a high-dimensional signal space onto a low-dimensional action or encoding space.

The extension to AI brand perception requires modifying two assumptions. First, the unit of capacity allocation is not the brand choice alternative but the perceptual dimension: LLMs allocate encoding capacity across eight dimensions rather than across brand alternatives. Second, the RI prediction is architectural rather than behavioral: AI observers are rationally inattentive to DO-layer information because its channel capacity cost exceeds its value for output reconstruction. Rate-distortion theory [@cover-2006-elements-information-theory] operationalizes the architectural constraint — a rate-distortion-optimal encoder that targets output fidelity will discard organizational-coordination signals. The rational-inattention framework formalizes the behavioral equivalent: even an encoder that could in principle process portfolio context will not, because the expected return on encoding that context is near zero. The bandwidth constraint introduced in Proposition 2 generalizes both frameworks to AI observers: the awareness gate is necessary but not sufficient; a perception channel with adequate bandwidth to encode portfolio context is also required. Zharnikov [-@zharnikov-2026-empirical-rate-distortion-curve-ai] provides empirical evidence for the compressed nature of LLM brand encodings, documenting a rate-distortion curve that places LLM encoders close to the theoretical minimum-distortion frontier. Figure 1 locates the relevant observer classes in the awareness-by-bandwidth plane, isolating the spectral-immunity region where awareness saturates but encoding bandwidth remains constrained.
...
**Proposition 1** (Interference conditionality). *Spectral interference between brands $B_i$ and $B_j$ within portfolio $\mathcal{P}$ requires three conditions, each of them necessary: (a) the brands share at least one observer cohort ($O(B_i, B_j) > 0$), (b) the awareness gate exceeds a minimum threshold ($\alpha_{C_k} > \alpha_{\min}$), and (c) the brands' emission profiles differ on at least one dimension weighted above a salience threshold by the shared cohort. The absence of any one condition suppresses interference entirely. The three are NOT claimed to be jointly sufficient: P1 says nothing about whether interference occurs when all three hold.*

*Derivation.* From equation 3, the interference term $I_d$ is zero when $\alpha_{C_k} = 0$ (no awareness), when $\bar{w}_d^{(C_k)} = 0$ (dimension not weighted), or when $e_d^{(B_j)} = \mu_d$ (brand is indistinguishable from category mean). Each condition is therefore necessary. The derivation establishes nothing about the converse: equation 3 gives the *potential* perturbation, and whether a non-zero $I_d$ is realized in an observable profile is a separate question, taken up in P2. Sufficiency is not claimed here and is not implied by the derivation. This matters for reading the results below, where all three conditions hold and interference is nonetheless absent — an outcome P1 as stated permits.
...
*Falsification.* P1 is a conjunction of three necessity claims, and each is separately falsifiable by removing that condition and observing interference anyway. The awareness condition is the one with an experimental handle: P1 is falsified if, in a controlled experiment where conditions (a) and (c) hold, absence of the awareness gate ($\alpha = 0$) fails to suppress interference — that is, if observer cohort overlap and spectral divergence alone produce non-zero perception cloud shifts without any awareness of the shared portfolio relationship. The present study cannot fire this condition. Its observers hold $\alpha \approx 1$ throughout and the design contains no $\alpha = 0$ arm, so nothing reported below bears on P1 either way; the test requires the human-observer design described under Future Research.
...
*Derivation.* Equation 3 shows that interference scales with $\alpha$. However, the equation models the *potential* perturbation, not the *realized* perturbation. Realization requires that the observer's encoding has sufficient representational capacity to propagate the interference term into the observable brand profile. When encoding is compressed — as in rate-distortion-optimal representations [@cover-2006-elements-information-theory; @sims-2003-implications-rational-inattention] — the interference term exists in the model's parameter space but cannot alter the observable output. This is formally identical to the rational-inattention result: the signal exists but is not processed because its channel cost exceeds its value. The bandwidth constraint also applies to the *static* case: Zharnikov [-@zharnikov-2026-spectral-metamerism-brand-perception-projection] shows that projection onto a compressed dimensional representation produces metameric null spaces in which two observably equivalent profiles may differ on dimensions the encoding discards — the portfolio context falls precisely into this null space for bandwidth-constrained AI observers.
...
*Derivation.* A highly coherent brand (tight perception cloud, low variance) experiences proportionally larger perturbation from a given interference magnitude than a diffuse cloud. This connects to the conviction asymmetry formalized in Zharnikov [-@zharnikov-2026-spectral-brand-theory-computational-framework] and to the type-over-score principle for coherence-graded resilience in Zharnikov [-@zharnikov-2026-coherence-type-as-crisis-predictor]: negative conviction forms faster and is more resistant to revision than positive conviction, and high-coherence brands occupy more fragile positions in perception space.
...
The portfolio condition operationalizes awareness via in-context ownership disclosure; this is distinct from pre-training-encoded ownership knowledge, and the two may produce different interference magnitudes — a distinction addressed in Boundary Conditions. The portfolio-context manipulation is a minimal single-sentence DO-layer disclosure; richer portfolio-context prompts (e.g., multi-sentence brand architecture or cross-promotion framing) were not tested and may produce different results.

An additional extension with 20 brands drawn from published marketing research [@aaker-1997-dimensions-brand-personality; @brakus-2009-brand-experience-what; @li-2024-frontiers-determining-validity; @erdem-1998-empirical-analysis-umbrella; @dew-2020-modeling-dynamic-heterogeneity; @morgan-2009-brand-portfolio-strategy; @malar-2011-emotional-brand-attachment] added 1,950 observations with zero overlap, bringing the combined dataset to 9,925 observations across 40 brands.

***Brands and Portfolios***

The 20 main-experiment brands span seven portfolios chosen to populate the archetype space, with each portfolio's predicted interference direction fixed in advance (Table 1).
...
The observer panel comprised 13 models drawn from seven training traditions, spanning Western, Chinese, Russian, Indian, Japanese, European, and Korean providers (Table 2).
...
One decision rule governs every verdict below, and it is stated before the verdicts so that it is visibly applied uniformly. Difference hypotheses (H1, H2, H4, H6, H7, H8, H9) are scored *supported* only on an effect that survives FDR correction at $\alpha$ = .05 across the 20 tests, and *not supported* otherwise, whatever the uncorrected magnitude. Equivalence hypotheses (H3, H5) are scored on TOST against the $\pm$1.0 DCI bound. No verdict is graded on direction, on an uncorrected *p*, or on a subset of cells chosen after the fact. Where an uncorrected effect is large enough to be worth recording, it is reported as an observation and named as one, and it does not move the verdict.
...
**H8 (Language-dependent immunity): Not supported.** No native-language effect survives FDR correction, which under the rule stated above settles the verdict. Two uncorrected observations are worth recording and do not change it: the Japanese Swallow model returns delta = -2.35 for Toyota and YandexGPT returns delta = +.72 for Yandex. Effects are portfolio-specific and model-specific with no systematic directional pattern. Because each tradition is represented by a single model, H8 and H9 cannot distinguish home-model amplification from model-specific idiosyncrasy in any case — the Swallow/Toyota effect (d = -2.35) may reflect a Swallow-specific response pattern rather than a general Japanese-tradition phenomenon. An earlier version scored H8 and H9 as *Mixed*; that label rested on uncorrected magnitude, which is not the basis on which H1, H2, H6 and H7 were scored, and it has been withdrawn in favour of the single rule.

**H9 (Home-model amplification): Not supported.** No home-model effect survives FDR correction. The largest uncorrected signal is again Swallow (Japanese) for Toyota (delta -2.35), and no consistent pattern holds across home-market pairs. Selective appearance in single-model traditions is what the exploratory design cannot distinguish from noise, and it is not scored as partial support.
...
*Notes*: The Japanese model (GPT-OSS-Swallow) shows the only tradition-level p-value below .05 (p = .011, d = -.63), driven primarily by Toyota-related brands. This does not survive FDR correction across 7 tradition comparisons. All other traditions show identical immunity. Most non-Western traditions are represented by a single model; tradition-level effects cannot be distinguished from model-specific idiosyncrasy. SEs for tradition-level Delta DCI means range from .04 to .21; full SE columns available in the online appendix.

***Multi-Turn Conversation: The Geely Auto Exception***

Multi-turn conversation is the most ecologically valid condition and the modality where the largest individual effects appear. Four brands showed FDR-significant DCI shifts after portfolio reveal (Table 6):
...
Pooled across archetypes and modalities, the portfolio-framing effect sizes converge toward zero, with the equivalence bounds enclosing nearly every estimate (Figure 2).
...
An analogous mechanism may operate in the opposite direction from the diversified portfolios analyzed here: the founder-dependent firm, where the WHAT specification is borne by a single individual and dimensional concentration is at its maximum. Pérez-González [-@prezgonzlez-2006-inherited-control-firm] finds, using inheritance-based natural experiments, a 2.09 percentage point industry- and performance-adjusted decline in operating return on assets following inherited family-CEO succession in U.S. public firms; Bennedsen et al. [-@bennedsen-2007-inside-family-firm], instrumenting succession with first-born child gender in a Danish sample, find an average decline of at least four percentage points (IV estimates ranging from -6.06 to -9.28). Whether the mechanism identified here at the AI-perception layer — that a low-cardinality channel encoding a WHAT specification does not survive a change in the observing system — extends to founder succession dynamics is a speculative parallel that future research could formalize. Both cases involve an output specification encoded in a channel that depends on a specific observer, but the empirical regularity in CEO succession studies may have multiple structural causes beyond the channel-dependency mechanism identified here.

***Proposition Support Summary***

**Proposition 1 (Interference conditionality): Not tested.** All three necessary conditions hold for the LLM observer: shared cohorts ($O > 0$, all brands rated by all models), maximal awareness gate ($\alpha \approx 1$), and dimensional differences between portfolio brands. Interference is nonetheless near zero. P1 as stated in the Theory section claims necessity only and is silent on this case, so the result neither supports nor falsifies it; testing P1 requires an $\alpha = 0$ arm the present design does not contain. What the result does bear on is the separate and widely held assumption that the three conditions are jointly *sufficient*, which it contradicts — that assumption is P2's subject, and P2 is where the finding is scored.
...
Table 8 situates the bandwidth-constraint mechanism alongside the prior portfolio-interference frameworks, isolating its unique prediction of null effects under saturated awareness.
...
|---|---|---|---|---|---|
| Markowitz [-@markowitz-1952-portfolio-selection-journal] portfolio theory | Variance-covariance minimization across assets | Not applicable | Not applicable | Systematic risk reduction through diversification | No |
| Aaker-Keller [-@aaker-1990-consumer-evaluations-brand] brand extension fit | Perceived fit moderates equity transfer | Necessary trigger | Not modeled | Positive at high fit; negative at low fit | No |
| Erdem-Sun [-@erdem-2002-empirical-investigation-spillover] umbrella branding | Quality signal propagates from parent to siblings | Amplifier | Not modeled | Positive, proportional to awareness | No |
| Lei-Dawar-Lemmink [-@lei-2008-negative-spillover-brand] asymmetric spillover | Negative effects propagate more strongly than positive | Asymmetric amplifier | Not modeled | Asymmetric; negative dominates | No |
| Berger-Ofek [-@berger-1995-diversifications-effect-firm] conglomerate discount | Portfolio coordination costs not recovered as output value | Not applicable | Not applicable | Value destruction; discount at financial-market scale | No |
...
Fifth, the propositions about interference direction predictability (P2), cohort-dependent coherence (P3), constructive interference compounding (P6), and portfolio capacity constraints (P7) of the spectral portfolio-theory framework [@zharnikov-2026q-spectral-portfolio-theory] cannot be tested with AI observers alone and require dedicated human-observer studies.
...
Seventh, the portfolio condition operationalizes awareness via in-context ownership disclosure. This is distinct from pre-training-encoded ownership knowledge: LLMs may have encoded ownership relationships during training without any explicit disclosure, and pre-training-only awareness (without prompt disclosure) was not separately tested. The two operationalizations may produce different interference magnitudes.

Eighth, results pertain to the specific model versions tested in April 2026; subsequent model generations with different architectures or training data may encode portfolio relationships differently, and replication with each new generation is recommended given the 18-24 month typical review cycle for marketing journals.
...
*Falsification conditions.* The condition previously stated for spectral immunity conjoined six requirements — a panel of 7+ models from 3+ traditions, DCI shifts above 2.0 points, effect sizes above .50, survival of multiple-testing correction, and both of these across 5+ portfolio archetypes and 3+ prompt modalities, all simultaneously. A six-way conjunction is close to unfalsifiable in practice, and this study's own largest result already clears three of the six: the present panel is 13 models drawn from seven training traditions, the Swallow/Toyota native-language cell returns a DCI shift of -2.35, and the Japanese tradition-level effect behind it is d = -.63 (Table 5). What stops that cell from being a refutation is FDR correction and the absence of a pattern across archetypes — which are two conjuncts, not six. The condition is therefore restated on the two that carry the content.

Spectral immunity (H5) is falsified if a study using the present design and a comparable panel finds portfolio-induced $|\Delta\text{DCI}|$ above the $\pm$1.0 TOST bound for more than half the brands tested, with those tests FDR-significant at $\alpha$ = .05. A narrower result also refutes immunity as a general property, though not for the remaining archetypes: any single portfolio archetype in which every brand shows an FDR-significant shift above the bound. Neither condition requires agreement across modalities or archetypes, and either could be produced by a single well-powered replication. Proposition 2 (awareness gate sufficiency inversion) is falsified if human-observer experiments with experimentally varied awareness gates fail to produce interference above threshold while LLMs remain immune.
...
This bandwidth constraint generalizes rational inattention [@sims-2003-implications-rational-inattention] to perceptual encoders and offers a unified explanation for the compression of Cultural, Temporal, and Social dimensions in LLM brand profiles [@zharnikov-2026-dimensional-collapse-ai-mediated-search], the stability of quantitative ratings versus relational context [@sabbah-2026-marketing-machines-how], and the structural divergence between LLM and human preferences [@goli-2024-frontiers-can-large]. The WHAT/DO distinction further connects the result to broader patterns in organizational economics: coordination costs that do not translate into output benefits are discounted by lossy observers, whether those observers are capital markets [@berger-1995-diversifications-effect-firm] or language models.
