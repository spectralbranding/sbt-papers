...
In January 2004, Dove launched the "Campaign for Real Beauty" with a series of billboards featuring photographs of women who did not conform to conventional beauty-industry standards. By 2007, Dove's global revenue had approximately doubled from ~$2B to ~$4B. By 2013, the "Real Beauty Sketches" video had accumulated over 163 million views, generating 4.6 billion public relations impressions and a 6% sales increase. By 2023, the brand reported EUR 6B in annual turnover -- its highest underlying sales growth in a decade (Unilever 2023). Among discrete purpose campaigns documented in the academic and practitioner literature, none has sustained comparable commercial performance over two decades (as distinct from long-term brand positioning, such as Patagonia's).

Despite two decades of commercial success and extensive academic commentary, the advertising research literature lacks a formal framework for explaining *how* purpose campaigns produce their effects at the perceptual level. Existing approaches to campaign effectiveness measurement -- from Keller's (2016) resonance model to aggregate brand tracking -- treat brand perception as a single construct and therefore cannot explain why the same campaign signals produce empowerment in some observers, indifference in others, and hostility in a third group simultaneously. The advertising literature has documented observer divergence in purpose campaigns as an authenticity-evaluation problem: Vredenburg et al. (2020) show that the same purpose signal produces either authentic activism or "woke washing" perceptions depending on the evaluating observer's credibility standards, while Mukherjee and Althuizen (2020) demonstrate that brand activism can simultaneously help and hurt a brand depending on the ideological alignment of the observer cohort. Corporate sociopolitical activism adds a further complication -- Bhagwat et al. (2020) find that firm value effects from activism are heterogeneous and cohort-contingent. Hydock, Paharia, and Weber (2022) provide large-scale experimental evidence that heterogeneous ideological responses to brand political advocacy follow a structured cohort logic: consumers whose political identity is activated by the brand's stance respond with greater conviction, positively or negatively, than consumers for whom the stance is identity-neutral. Korschun, Bhattacharya, and Sen (2024) document authenticity penalties that are similarly cohort-dependent: observers who perceive moral signaling as inconsistent with prior brand behavior produce stronger negative evaluations than observers encountering the same signal without prior expectations. A systematic review of the brand activism literature (Mirzaei, Wilkie, and Siuki 2023) identifies this multi-dimensional, cohort-level gap as the field's primary open problem. Despite this convergent awareness that observer heterogeneity is the central phenomenon, the advertising literature lacks a formal framework for predicting the *structure* of that divergence. Recent calls in *Journal of Advertising Research* for multi-dimensional approaches to campaign evaluation (Fetscherin and Heinrich 2015) reflect growing awareness that aggregate metrics obscure the structural dynamics of campaign reception. This paper responds to those calls by providing what is, to the author's knowledge, the first SBT-eight-dimension longitudinal decomposition of a purpose campaign -- tracking dimensional shifts across four cross-sections over twenty years with four structurally distinct observer cohorts.
...
This paper applies Spectral Brand Theory (SBT; Zharnikov 2026a) -- a framework that represents brand perception as emission profiles across eight typed dimensions, received by heterogeneous observer cohorts with different spectral weight vectors -- to provide a formal account of all three phenomena. The contribution is threefold:

1. **Multi-dimensional longitudinal decomposition** (Signal Decomposition section): This paper provides what is, to the author's knowledge, the first application of the SBT eight-dimensional framework to longitudinal purpose campaign analysis, extending prior multi-dimensional work (Brakus et al. 2009; Holt 2002, 2004) with an explicit eight-dimension emission model and four cohort-specific perception trajectories.
...
The analysis draws on three categories of evidence. **Corporate data**: Unilever Annual Reports (2003--2023), brand revenue and campaign expenditure data. **Academic perception studies**: Georgeson (2018, 326-woman survey), Garick (2023, 1,000 YouTube comments), Bissell and Rask (2010, self-discrepancy effects), Hwang et al. (2016, perception divergence), Taylor et al. (2016, critical discourse analysis). **Critical and cultural studies**: Murray (2013, genderwashing analysis), Gill (2007, post-feminist critique), Werleman (2016, Dove/Axe contamination).
...
**Cohort 1: Purpose-Aligned (PA).** Observers who weight Ideological and Narrative dimensions most heavily. They respond to Dove primarily as a values-driven brand. Supporting evidence: Georgeson (2018) identifies a substantial cluster for whom the campaign's social message is the primary driver of brand preference; Hwang et al. (2016) document assimilative processing in observers with congruent attitudes toward body diversity.

**Cohort 2: Product-Pragmatist (PP).** Observers who weight Experiential and Economic dimensions most heavily. They purchase Dove for product quality and price. The campaign is noticed but not determinative. Supporting evidence: Garick (2023) identifies commenters who discuss product attributes independently of campaign messaging.

**Cohort 3: Social-Signal Reader (SS).** Observers who weight Social and Cultural dimensions most heavily. They engage with Dove as a social signaling mechanism. Supporting evidence: the viral dynamics of "Real Beauty Sketches" (163M+ views) demonstrate engagement with Dove content as social currency; temporal decline in sharing rates post-2019 (Garick 2023) indicates dependence on Cultural dimension novelty.
...
**Social-Signal Reader: Cloud formation (social currency).** Social dimension activated intensely; sharing the video became a social act. However, conviction was content-mediated rather than brand-direct, meaning it decays faster (Zharnikov 2026j).
...
The four Dove cohorts perceive structurally different brands: an ideological movement (PA), a soap (PP), social currency (SS), and corporate hypocrisy (SC). This heterogeneity formalizes what Grier and Brumbaugh (1999) documented in advertising response and what Puntoni, Schroeder, and Ritson (2010) described as advertising polysemy. Reczek, Irwin, and Barasch (2023) demonstrate that whether consumers perceive brands as having a moral duty to take political stances -- and how they respond when brands do -- is itself cohort-contingent in ways that aggregate approval metrics cannot detect; P2's formal prediction of cohort-specific conviction valence provides the structural mechanism their results require.
...
The Unilever paradox is a predictable spectral effect. The prediction that Skeptic-Critic cohort growth will be proportional to portfolio contradiction awareness is directly testable. Becker-Olsen, Cudmore, and Hill (2006) demonstrate that low-fit CSR initiatives generate negative consumer responses; portfolio contradiction is the structural mechanism producing low fit at the corporate level, not merely at the campaign level.
...
The temporal dynamics documented in Tables 1 and 3 -- particularly the Cultural dimension decay from 8.5 to 5.5 over 17 years -- are operationalized via per-dimension velocity tracking in the sbt-framework computational toolkit (Zharnikov 2026a), which is in development and available on request. Keller and Lehmann (2006) identify longitudinal campaign analysis as among the highest-priority gaps in brand research; the velocity tracking operationalization responds to that gap by providing a formal leading-indicator mechanism for brand managers to monitor rather than retrospectively diagnose campaign-phase transitions. The velocity report provides signed velocity, direction (rising/falling/stable), acceleration, and estimated time-to-absorption for each dimension, implementing the drift vector formalism of Zharnikov (2026j) as a discrete approximation. This converts the qualitative trajectory described in the Coherence Audit section into a quantitative monitoring capability: advertising managers can track Cultural dimension velocity as a leading indicator of counter-cultural decay, rather than diagnosing it retrospectively.
...
**Limitation 2: Post-hoc cohort identification.** The four observer cohorts are constructed from existing academic perception studies not designed to test SBT's predictions. The spectral weight vectors in Table 2 are the author's synthesis of documented response patterns, not survey-derived estimates, and cohort sizes are not reported. Future research should administer a validated spectral profile instrument (such as the PRISM-B protocol described in Zharnikov 2026v) to a large representative sample before conducting the campaign analysis, establishing cohort assignments prospectively rather than retrospectively. Latent-class segmentation methods (Wedel and Kamakura 2000) provide a natural statistical framework for recovering cohort membership from response data when prior theory supplies the dimension structure; the spectral weight vectors in Table 2 translate directly into starting values for such an estimation procedure.
...
Akestam, Nina, Sara Rosengren, and Micael Dahlen (2017), "Advertising 'Like a Girl': Toward a Better Understanding of 'Femvertising' and Its Effects," *Psychology & Marketing*, 34 (8), 795--806.

Becker-Olsen, Karen L., B. Andrew Cudmore, and Ronald Paul Hill (2006), "The Impact of Perceived Corporate Social Responsibility on Consumer Behavior," *Journal of Business Research*, 59 (1), 46--53. https://doi.org/10.1016/j.jbusres.2005.01.001

Bhagwat, Yashoda, Nooshin L. Warren, Joshua T. Beck, and George F. Watson IV (2020), "Corporate Sociopolitical Activism and Firm Value," *Journal of Marketing*, 84 (5), 1--21. https://doi.org/10.1177/0022242920937000

Bissell, Kimberly L. and Angeline Rask (2010), "Real Women on Real Beauty: Self-Discrepancy, Internalisation of the Thin Ideal, and Perceptions of Attractiveness and Thinness in Dove's Campaign for Real Beauty," *International Journal of Advertising*, 29 (4), 643--668.
...
Eyada, Basma (2020), "Brand Activism, the Relation and Impact on Consumer Perception: A Case Study on Nike Advertising," *International Journal of Marketing Studies*, 12 (4), 30--42.

Fetscherin, Marc and Daniel Heinrich (2015), "Consumer Brand Relationships Research: A Bibliometric Citation Meta-Analysis," *Journal of Business Research*, 68 (2), 380--390.

Garick, L. (2023), "Public Perception of Dove's Campaign for Real Beauty: A Content Analysis of YouTube Comments" [Master's thesis], University of Central Florida.

Georgeson, E. (2018), "The Dove Campaign for Real Beauty: A Study of Generational Perceptions" [Master's thesis], Rochester Institute of Technology.
...
Hermann, Erik, Stefano Puntoni, and David A. Schweidel (2026), "Trusting AI Agents: Uncertainty Reduction by Design," SSRN Working Paper. https://doi.org/10.2139/ssrn.6103206
...
Holt, Douglas B. (2004), *How Brands Become Icons*, Harvard Business School Press.

Hydock, Chris, Neeru Paharia, and Sean Weber (2022), "The Consumer Response to Corporate Political Advocacy," *Journal of Marketing Research*, 59 (4), 769--787.

Hwang, Y., J. Yoo, and K.H. Kim (2016), "Consumer Perceptions of Dove's 'Campaign for Real Beauty': A Brand Equity Perspective," in *Advances in Advertising Research*, Vol. VI, Springer, 229--240.

Kapferer, Jean-Noel (2008), *The New Strategic Brand Management: Creating and Sustaining Brand Equity Long Term*, 4th ed., Kogan Page.

Korschun, Daniel, Chitra Bhattacharya, and Sankar Sen (2024), "When Brands Take a Stand: The Double-Edged Sword of Moral Signaling," *Journal of Consumer Research*, 51 (2), 215--234.

Keller, Kevin Lane (1993), "Conceptualizing, Measuring, and Managing Customer-Based Brand Equity," *Journal of Marketing*, 57 (1), 1--22.

Keller, Kevin Lane (2016), "Reflections on Customer-Based Brand Equity: Perspectives, Progress, and Priorities," *AMS Review*, 6 (1), 1--16.
...
Mirzaei, Abas, Dean C. H. Wilkie, and Hoda Siuki (2023), "Woke Brand Activism Authenticity or the Lack of It," *Journal of Business Research*, 162, 113882. https://doi.org/10.1016/j.jbusres.2023.113882
...
Murray, Derek P. (2013), "Branding 'Real' Social Change in Dove's Campaign for Real Beauty," *Feminist Media Studies*, 13 (1), 83--101.

Peters, Ole (2019), "The Ergodicity Problem in Economics," *Nature Physics*, 15 (12), 1216--1221.

Puntoni, Stefano, Jonathan E. Schroeder, and Mark Ritson (2010), "Meaning Matters: Polysemy in Advertising," *Journal of Advertising*, 39 (2), 51--64.

Reczek, Rebecca Walker, Julie R. Irwin, and Alixandra Barasch (2023), "Do Brands Have a Moral Duty? Consumer Responses to Corporate Sociopolitical Activism," *Journal of Marketing Research*, 60 (6), 1057--1075.

Sabbah, Jafar and Oguz A. Acar (2026), "Marketing to Machines: How AI Models Respond to Promotional Cues," SSRN Working Paper. https://doi.org/10.2139/ssrn.6406639

Taylor, Judith, Josée Johnston, and Krista Whitehead (2016), "A Corporation in Feminist Clothing? Young Women Discuss the Dove 'Campaign for Real Beauty,'" *Critical Sociology*, 42 (1), 123--144. https://doi.org/10.1177/0896920513501355

Unilever (2003), *Annual Report and Accounts 2003*, Unilever PLC.

Unilever (2007), *Annual Report and Accounts 2007*, Unilever PLC.

Unilever (2011), *Annual Report and Accounts 2011*, Unilever PLC.

Unilever (2023), *Annual Report and Accounts 2023*, Unilever PLC.

Vanhamme, Joëlle and Bas Grobben (2009), "'Too Good to Be True!' The Effectiveness of CSR History in Countering Negative Publicity," *Journal of Business Ethics*, 85 (2), 273--283.

Vredenburg, Jessica, Sommer Kapitan, Amanda Spry, and Joya A. Kemker (2020), "Brands Taking a Stand: Authentic Brand Activism or Woke Washing?" *Journal of Public Policy & Marketing*, 39 (4), 444--460.

Wedel, Michel and Wagner A. Kamakura (2000), *Market Segmentation: Conceptual and Methodological Foundations*, Springer.

Werleman, G. (2016), "Real Beauty? The Effect of Parent Brand Unilever's Contradicting Portfolio on Consumer Perception of Dove" [Master's thesis], University of Amsterdam.
