...
The analysis draws on three categories of evidence. **Corporate data**: Unilever Annual Reports (2003--2023), brand revenue and campaign expenditure data. **Academic perception studies**: Bissell and Rask (2010, self-discrepancy effects), Hwang et al. (2016, perception divergence), Taylor et al. (2016, critical discourse analysis). **Critical and cultural studies**: Murray (2013, genderwashing analysis), Gill (2007, post-feminist critique), Werleman (2016, Dove/Axe contamination).
...
**Cohort 1: Purpose-Aligned (PA).** Observers who weight Ideological and Narrative dimensions most heavily. They respond to Dove primarily as a values-driven brand. Supporting evidence: Hwang et al. (2016) document assimilative processing in observers with congruent attitudes toward body diversity, consistent with the pattern in which the campaign's social message is the primary driver of brand preference for this cohort.
...
**Cohort 4: Skeptic-Critic (SC).** Observers who weight Ideological dimensions heavily but assign *negative* conviction when they perceive ideological inconsistency. Supporting evidence: Murray (2013) documents genderwashing; Taylor et al. (2016) identify "faux feminism"; publicly accessible Dove YouTube comment threads consistently show that comments addressing the parent corporation rather than campaign content skew negative, while comments addressing the campaign message itself skew positive.
...
*Notes*: DCI values reported on the decimal scale (uniform baseline .250) consistent with Zharnikov (2026v). Cohen's d = .878 is an effect size for the local-versus-global contrast, not a DCI value.
...
Anisimova, Tatiana, Zonia Lee, and Marcos Andre Ramos da Silva (2025), "Brand Activism in the Era of Permacrisis: Systematic Literature Review and Future Research Agenda," *Journal of Marketing Management*. https://doi.org/10.1080/0267257X.2025.2488800
...
Guha, Mita, Daniel Korschun, and Tina Larsen Andras (2026), "The Double-Edged Sword: Polarized Stakeholder Engagement with Corporate Sociopolitical Activism and Its Downstream Effects on Brand Performance," *Journal of Business Research*, 204, 115861. https://doi.org/10.1016/j.jbusres.2025.115861
...
Hydock, Chris, Neeru Paharia, and Thomas J. Weber (2022), "Differential Response to Corporate Political Advocacy and Corporate Social Responsibility: Implications for Political Polarization and Radicalization," *Journal of Public Policy & Marketing*, 42 (1), 113--130. https://doi.org/10.1177/07439156221133073
...
Reczek, Rebecca Walker, Allan Fenigstein, and Mark G. Serafin (2023), "Do Brands Have a Moral Duty? Consumer Responses to Corporate Sociopolitical Activism," *Journal of Marketing Research*, 60 (5), 687--708. https://doi.org/10.1177/00222437231180494
