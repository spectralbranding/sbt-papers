...
1. **Multi-dimensional longitudinal decomposition** (Signal Decomposition section): This paper provides what is, to the author's knowledge, the first application of an eight-dimensional perceptual framework to longitudinal purpose campaign analysis, extending prior multi-dimensional work (Brakus et al. 2009; Holt 2002, 2004) with an explicit eight-dimension emission model and four cohort-specific perception trajectories.
...
### *"Real Beauty Sketches" (2013): Four Perception Events*

The 2013 "Real Beauty Sketches" video produced four structurally distinct perception events:
...
| Brand | Sem | Nar | Ide | Exp | Soc | Eco | Cul | Tem | Coherence |
|-------|-----|-----|-----|-----|-----|-----|-----|-----|-----------|
| Dove (2023) | 7.0 | 7.5 | 7.5 | 7.0 | 6.5 | 6.5 | 5.5 | 7.5 | Identity |
| Patagonia | 6.0 | 9.0 | 9.5 | 7.5 | 8.0 | 5.0 | 7.0 | 6.5 | Identity |
| Hermes | 9.5 | 9.0 | 7.0 | 9.0 | 8.5 | 3.0 | 9.0 | 9.5 | Ecosystem |
| IKEA | 8.0 | 7.5 | 6.0 | 7.0 | 5.0 | 9.0 | 7.5 | 6.0 | Signal |
| Tesla | 7.5 | 8.5 | 3.0 | 6.0 | 7.0 | 6.0 | 4.0 | 2.0 | Incoherent |
...
Dove's Ideological dimension was null before 2004. Activation did not require observers to change existing convictions -- only to form new ones in unoccupied territory. Pepsi's failure and Gillette's backlash confirm the inverse: activating dimensions that contradict existing emissions produces cross-dimensional dissonance.

*Falsification: P1 is falsified if purpose campaigns activating a previously null dimension produce equivalent or lower revenue growth than campaigns intensifying existing dimensions, controlling for campaign spend and category baseline growth.*
...
The four Dove cohorts perceive structurally different brands: an ideological movement (PA), a soap (PP), social currency (SS), and corporate hypocrisy (SC). This heterogeneity formalizes what Grier and Brumbaugh (1999) documented in advertising response and what Puntoni, Schroeder, and Ritson (2010) described as advertising polysemy.
...
The Unilever paradox is a predictable spectral effect. The prediction that Skeptic-Critic cohort growth will be proportional to portfolio contradiction awareness is directly testable.
...
The mirror-cohort finding also formalizes Mukherjee and Althuizen's (2020) central empirical result: brand activism produces simultaneously positive and negative effects depending on observer ideological alignment. Their study treats observer alignment as a moderator on a single brand attitude construct. R10's framework recasts the same finding as a cohort-defining property: PA and SC cohorts are not the same population at different positions on a moderator scale, but structurally distinct observer types with different weight vectors that produce different perception clouds from identical signals. The two interpretations make different predictions about intervention design. A moderator-based reading suggests the brand should target the alignment dimension to shift outcomes; a cohort-based reading suggests the brand should design for coexistent positive and negative reception, recognizing that no signal will produce uniform response across cohorts with mirrored Ideological weights.
...
This paper has shown that Spectral Brand Theory provides a framework capable of explaining three phenomena in Dove's twenty-year Campaign for Real Beauty that existing frameworks cannot address: observer heterogeneity in purpose perception, portfolio-level spectral interference, and counter-cultural signal decay.

The central finding is that Dove's campaign succeeded through *dimensional creation* -- the activation of a previously null Ideological dimension that opened new perceptual territory. This mechanism explains both the campaign's disproportionate commercial impact and its vulnerability: the new dimension attracted positive conviction from Purpose-Aligned observers and negative conviction from Skeptic-Critics who weighted the same dimension but evaluated it against a broader corporate coherence standard.

The four observer cohorts are structural consequences of SBT's formalism: given eight-dimensional emission profiles and heterogeneous observer spectral weight vectors, structurally distinct perception clouds are predicted (Zharnikov 2026f). The Dove case makes this vivid: the same "Real Beauty Sketches" video simultaneously strengthened positive conviction in one cohort, was irrelevant to another, generated social currency for a third, and intensified negative conviction in a fourth.
...
Bhagwat, Yiorgos, Nooshin L. Warren, Joshua T. Beck, and George F. Watson IV (2020), "Corporate Sociopolitical Activism and Firm Value," *Journal of Marketing*, 84 (5), 1--21.
...
Hermann, Erik, Stefano Puntoni, and David A. Schweidel (2026), "Trusting AI Agents: Uncertainty Reduction by Design," SSRN 6103206.
...
Kietzmann, Jan, Jeff Paschen, and Emily Treen (2018), "Artificial Intelligence in Advertising: How Marketers Can Leverage Artificial Intelligence Along the Consumer Journey," *Journal of Advertising Research*, 58 (3), 263--267.
...
Sabbah, Maan and Oguz A. Acar (2026), "Marketing to Machines: How Brands Can Thrive in the Era of AI-Mediated Commerce," SSRN 6406639.

Taylor, J., J. Johnston, and K. Whitehead (2016), "A Corporation in Feminist Clothing? Young Women Discuss the Dove 'Campaign for Real Beauty,'" *Critical Sociology*, 42 (1), 123--144.
...
Vredenburg, Jessica, Sommer Kapitan, Amanda Spry, and J.A. Kemper (2020), "Brands Taking a Stand: Authentic Brand Activism or Woke Washing?" *Journal of Public Policy & Marketing*, 39 (4), 444--460.
